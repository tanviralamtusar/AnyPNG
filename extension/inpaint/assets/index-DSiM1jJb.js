...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},rp=(e,t)=>new fo(e,t)}),ho,ji,mo,go,_o,yo,Ue,ip,ap,xt=U(()=>{J(),re(),ve(),ie(),ho=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},ji=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),mo=(e,t)=>C.sortBasedOnPerm(e,ji(e.length,t)),go=(e,t,r,a)=>{let n=`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let i=0;i<t;++i)n+=`a[${e[i]}]=i[${i}];`;return n+="return a;}"},_o=(e,t)=>{let r=[],a=[];for(let n=0;n<e.length;++n)e[n]!==1&&r.push(e[n]),e[t[n]]!==1&&a.push(t[n]);return{newShape:r,newPerm:a}},yo=(e,t)=>{let r=0;for(let a=0;a<e.length;++a)if(t[e[a]]!==1){if(e[a]<r)return!1;r=e[a]}return!0},Ue=(e,t)=>{let r=e.dataType,a=e.dims.length,n=ji(a,t),i=mo(e.dims,n),s=e.dims,u=i,d=a<2||yo(n,e.dims),l;if(d)return l=_=>{let b=R("input",r,s,4),x=H("output",r,u,4);return`
  ${_.registerUniform("output_size","u32").declareVariables(b,x)}
  ${_.mainStart()}
    ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=C.size(i);return{outputs:[{dims:i,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:l};let{newShape:c,newPerm:f}=_o(e.dims,n),h=C.areEqual(f,[2,3,1]),g=C.areEqual(f,[3,1,2]);if(c.length===2||h||g){s=h?[c[0],c[1]*c[2]]:g?[c[0]*c[1],c[2]]:c,u=[s[1],s[0]];let _=16;return l=b=>{let x=R("a",r,s.length),$=H("output",r,u.length);return`
  ...
  ${_.mainStart()}
    ...
    ${x.setByOffset("global_idx",b.getByIndices("aIndices"))}
  }`},{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let _=C.size(i);return{outputs:[{dims:i,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...X(s,u)]}},getShaderSource:l}},ip=(e,t)=>{ho(e.inputs,t.perm),e.compute(Ue(e.inputs[0],t.perm))},ap=e=>fe({perm:e.perm})}),bo,wo,$o,vo,xo,So,ko,Io,To,Eo,je,np,sp,op,up,lp,dp,pp,cp,fp,hp,ig=U(()=>{J(),re(),ie(),un(),xt(),bo={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},wo={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},$o={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},vo={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},xo=(e,t)=>{let r=[];for(let a=t-e;a<t;++a)r.push(a);return r},So=(e,t)=>{let r=[],a=e.length;for(let i=0;i<a;i++)t.indexOf(i)===-1&&r.push(e[i]);let n=t.map(i=>e[i]);return[r,n]},ko=(e,t)=>{let r=e.length+t.length,a=[],n=0;for(let i=0;i<r;i++)t.indexOf(i)===-1?a.push(e[n++]):a.push(1);return a},Io=(e,t)=>{for(let r=0;r<e.length;++r)if(e[e.length-r-1]!==t-1-r)return!1;return!0},To=(e,t)=>{let r=[];if(!Io(e,t)){for(let a=0;a<t;++a)e.indexOf(a)===-1&&r.push(a);e.forEach(a=>r.push(a))}return r},Eo=(e,t,r,a,n,i,s)=>{let u=r[0].dims,d=C.size(i),l=C.size(s),c=R("_A",r[0].dataType,u),f=H("output",n,i),h=64;d===1&&(h=256);let g=`
       ...
       `,_=b=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${h}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:i,dataType:n}],dispatchGroup:{x:d},programUniforms:[{type:12,data:l}]})}},je=(e,t,r,a)=>{let n=e.inputs.length===1?r:Aa(e.inputs,r),i=n.axes;i.length===0&&!n.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((g,_)=>_));let s=C.normalizeAxes(i,e.inputs[0].dims.length),u=s,d=e.inputs[0],l=To(u,e.inputs[0].dims.length);l.length>0&&(d=e.compute(Ue(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],u=xo(u.length,d.dims.length));let[c,f]=So(d.dims,u),h=c;n.keepDims&&(h=ko(c,s)),e.compute(Eo(t,n.cacheKey,[d],a,e.inputs[0].dataType,h,f),{inputs:[d]})},np=(e,t)=>{je(e,"ReduceMeanShared",t,"mean")},sp=(e,t)=>{je(e,"ReduceL1Shared",t,"l1")},op=(e,t)=>{je(e,"ReduceL2Shared",t,"l2")},up=(e,t)=>{je(e,"ReduceLogSumExpShared",t,"logSumExp")},lp=(e,t)=>{je(e,"ReduceMaxShared",t,"max")},dp=(e,t)=>{je(e,"ReduceMinShared",t,"min")},pp=(e,t)=>{je(e,"ReduceProdShared",t,"prod")},cp=(e,t)=>{je(e,"ReduceSumShared",t,"sum")},fp=(e,t)=>{je(e,"ReduceSumSquareShared",t,"sumSquare")},hp=(e,t)=>{je(e,"ReduceLogSumShared",t,"logSum")}}),Ge,zo,Qr,Aa,He,Co,Ao,Oo,Bo,Ro,Mo,Do,No,Po,Uo,Fe,mp,gp,_p,yp,bp,wp,$p,vp,xp,Sp,un=U(()=>{J(),re(),ve(),ie(),ig(),Ge=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},zo=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Qr=(e,t,r,a,n,i,s=!1,u=!1)=>{let d=[],l=r[0].dims,c=l.length,f=C.normalizeAxes(n,c),h=!u&&f.length===0;l.forEach((b,x)=>{h||f.indexOf(x)>=0?s&&d.push(1):d.push(b)});let g=d.length,_=C.size(d);return{name:e,shaderCache:t,getShaderSource:b=>{let x=[],$=R("_A",r[0].dataType,c),w=H("output",i,g),k=a($,w,f),S=k[2];for(let I=0,E=0;I<c;I++)h||f.indexOf(I)>=0?(s&&E++,S=`for(var j${I}: u32 = 0; j${I} < ${l[I]}; j${I}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:d,dataType:i}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...X(l,d)]})}},Aa=(e,t)=>{let r=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),fe({axes:r,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},He=(e,t,r,a)=>{let n=e.inputs,i=n.length===1?r:Aa(n,r);e.compute(Qr(t,{hint:i.cacheKey,inputDependencies:["rank"]},[n[0]],i.noopWithEmptyAxes&&i.axes.length===0?zo:a,i.axes,n[0].dataType,i.keepDims,i.noopWithEmptyAxes),{inputs:[0]})},Co=(e,t)=>{Ge(e.inputs),He(e,"ReduceLogSum",t,(r,a)=>[`var value = ${a.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,"value = log(value);"])},Ao=(e,t)=>{Ge(e.inputs),He(e,"ReduceL1",t,(r,a)=>[`var value = ${a.type.storage}(0);`,"",`value += abs(${r.getByIndices("input_indices")});`,""])},Oo=(e,t)=>{Ge(e.inputs),He(e,"ReduceL2",t,(r,a)=>[`var t = ${a.type.value}(0); var value = ${a.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Bo=(e,t)=>{Ge(e.inputs),He(e,"ReduceLogSumExp",t,(r,a)=>[`var value = ${a.type.storage}(0);`,"",`value += exp(${r.getByIndices("input_indices")});`,"value = log(value);"])},Ro=(e,t)=>{Ge(e.inputs),He(e,"ReduceMax",t,(r,a,n)=>{let i=[];for(let s=0;s<r.rank;s++)(n.indexOf(s)>=0||n.length===0)&&i.push(r.indicesSet("input_indices",s,0));return[`${i.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = max(value, ${r.getByIndices("input_indices")});`,""]})},Mo=(e,t)=>{Ge(e.inputs),He(e,"ReduceMean",t,(r,a,n)=>{let i=1;for(let s=0;s<r.rank;s++)(n.indexOf(s)>=0||n.length===0)&&(i*=e.inputs[0].dims[s]);return["var sum = f32(0);","",`sum += f32(${r.getByIndices("input_indices")});`,`let value = ${a.type.value}(sum / ${i});`]})},Do=(e,t)=>{Ge(e.inputs),He(e,"ReduceMin",t,(r,a,n)=>{let i=[];for(let s=0;s<r.rank;s++)(n.indexOf(s)>=0||n.length===0)&&i.push(`input_indices[${s}] = 0;`);return[`${i.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = min(value, ${r.getByIndices("input_indices")});`,""]})},No=(e,t)=>{Ge(e.inputs),He(e,"ReduceProd",t,(r,a)=>[`var value = ${a.type.storage}(1);`,"",`value *= ${r.getByIndices("input_indices")};`,""])},Po=(e,t)=>{Ge(e.inputs),He(e,"ReduceSum",t,(r,a)=>[`var value = ${a.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,""])},Uo=(e,t)=>{Ge(e.inputs),He(e,"ReduceSumSquare",t,(r,a)=>[`var t = ${a.type.value}(0); var value = ${a.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += t * t;`,""])},Fe=(e,t,r)=>{if(t.length===0)return r;let a=1,n=1;for(let i=0;i<t.length;i++)t.indexOf(i)===-1?a*=e[i]:n*=e[i];return n<32&&a>1024},mp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Mo(e,t):np(e,t)},gp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ao(e,t):sp(e,t)},_p=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Oo(e,t):op(e,t)},yp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Bo(e,t):up(e,t)},bp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ro(e,t):lp(e,t)},wp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Do(e,t):dp(e,t)},$p=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?No(e,t):pp(e,t)},vp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Po(e,t):cp(e,t)},xp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Uo(e,t):fp(e,t)},Sp=(e,t)=>{Fe(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Co(e,t):hp(e,t)}}),Gi,kp,Ip,Oa,ag=U(()=>{J(),ve(),un(),Gi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},kp=(e,t)=>{Gi(e.inputs);let r=(a,n,i)=>{let s=[];for(let u=0;u<a.rank;u++)(i.indexOf(u)>=0||i.length===0)&&s.push(`input_indices[${u}] = 0;`);return[`${s.join(`
`)}`,`var value = ${a.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?"<=":"<"} value) {
         value = ${a.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",n.setByOffset("global_idx","best_index")]};e.compute(Qr("ArgMin",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],r,[t.axis],7,t.keepDims),{inputs:[0]})},Ip=(e,t)=>{Gi(e.inputs);let r=(a,n,i)=>{let s=[];for(let u=0;u<a.rank;u++)(i.indexOf(u)>=0||i.length===0)&&s.push(`input_indices[${u}] = 0;`);return[`${s.join(`
`)}`,`var value = ${a.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${a.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",n.setByOffset("global_idx","best_index")]};e.compute(Qr("argMax",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],r,[t.axis],7,t.keepDims),{inputs:[0]})},Oa=e=>fe(e)}),qo,Nr,Wo,Lo,Vo,_r,jo,Tp,ln=U(()=>{J(),re(),sn(),ie(),qo=(e,t)=>{let r=e[0],a=e[1],n=e[2],i=e[3],s=e[4],u=e[5];if(s&&u)throw new Error("Attention cannot have both past and attention_bias");if(r.dims.length!==3)throw new Error('Input "input" must have 3 dimensions');let d=r.dims[0],l=r.dims[1],c=r.dims[2];if(n.dims.length!==1)throw new Error('Input "bias" is expected to have 1 dimensions');if(a.dims.length!==2)throw new Error('Input "weights" is expected to have 2 dimensions');if(a.dims[0]!==c)throw new Error("Input 1 dimension 0 should have same length as dimension 2 of input 0");if(n.dims[0]!==a.dims[1])throw new Error('Input "bias" dimension 0 should have same length as dimension 1 of input "weights"');let f=n.dims[0]/3,h=f,g=h;if(t.qkvHiddenSizes.length>0){if(t.qkvHiddenSizes.length!==3)throw new Error("qkv_hidden_sizes attribute should have 3 elements");for(let k of t.qkvHiddenSizes)if(k%t.numHeads!==0)throw new Error("qkv_hidden_sizes should be divisible by num_heads");f=t.qkvHiddenSizes[0],h=t.qkvHiddenSizes[1],g=t.qkvHiddenSizes[2]}let _=l;if(f!==h)throw new Error("qkv_hidden_sizes first element should be same as the second");if(n.dims[0]!==f+h+g)throw new Error('Input "bias" dimension 0 should have same length as sum of Q/K/V hidden sizes');let b=0;if(s){if(h!==g)throw new Error('Input "past" expect k_hidden_size == v_hidden_size');if(s.dims.length!==5)throw new Error('Input "past" must have 5 dimensions');if(s.dims[0]!==2)throw new Error('Input "past" first dimension must be 2');if(s.dims[1]!==d)throw new Error('Input "past" second dimension must be batch_size');if(s.dims[2]!==t.numHeads)throw new Error('Input "past" third dimension must be num_heads');if(s.dims[4]!==h/t.numHeads)throw new Error('Input "past" fifth dimension must be k_hidden_size / num_heads');t.pastPresentShareBuffer||(b=s.dims[3])}let x=_+b,$=-1,w=0;if(i)throw new Error("Mask not supported");if(s)throw new Error("past is not supported");if(u){if(u.dims.length!==4)throw new Error('Input "attention_bias" must have 4 dimensions');if(u.dims[0]!==d||u.dims[1]!==t.numHeads||u.dims[2]!==l||u.dims[3]!==x)throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)')}return{batchSize:d,sequenceLength:l,pastSequenceLength:b,kvSequenceLength:_,totalSequenceLength:x,maxSequenceLength:$,inputHiddenSize:c,hiddenSize:f,vHiddenSize:g,headSize:Math.floor(f/t.numHeads),vHeadSize:Math.floor(g/t.numHeads),numHeads:t.numHeads,isUnidirectional:!1,pastPresentShareBuffer:!1,maskFilterValue:t.maskFilterValue,maskType:w,scale:t.scale,broadcastResPosBias:!1,passPastInKv:!1,qkvFormat:1}},Nr=(e,t,r)=>t&&e?`
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:u,programUniforms:l}),getShaderSource:c},{inputs:d,outputs:[-1,-1,-1]})},Tp=(e,t)=>{let r=qo(e.inputs,t),[a,n,i]=jo(e,r);return _r(e,a,n,i,e.inputs[4],void 0,void 0,void 0,e.inputs[5],r)}}),Go,Ho,Fo,Ep,ng=U(()=>{Je(),J(),re(),ve(),ie(),Go=(e,t)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let r=(a,n,i)=>{let s=n.length;if(s!==a.length)throw new Error(`${i}: num dimensions != ${s}`);n.forEach((u,d)=>{if(u!==a[d])throw new Error(`${i}: dim[${d}] do not match`)})};if(e[0].dims.length>1){let a=t.format==="NHWC"?t.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,t.spatial?2:void 0);r(e[1].dims,a,"Invalid input scale"),r(e[2].dims,a,"Invalid input B"),r(e[3].dims,a,"Invalid input mean"),r(e[4].dims,a,"Invalid input var")}else r(e[1].dims,[1],"Invalid input scale"),r(e[2].dims,[1],"Invalid input B"),r(e[3].dims,[1],"Invalid input mean"),r(e[4].dims,[1],"Invalid input var")},Ho=(e,t)=>{let{epsilon:r,spatial:a,format:n}=t,i=e[0].dims,s=a?$e(i[i.length-1]):1,u=n==="NHWC"&&i.length>1?s:1,d=C.size(i)/s,l=a,c=l?i.length:i,f=R("x",e[0].dataType,e[0].dims,s),h=R("scale",e[1].dataType,e[1].dims,u),g=R("bias",e[2].dataType,e[2].dims,u),_=R("inputMean",e[3].dataType,e[3].dims,u),b=R("inputVar",e[4].dataType,e[4].dims,u),x=H("y",e[0].dataType,c,s),$=()=>{let k="";if(a)k=`let cOffset = ${i.length===1?"0u":n==="NHWC"?`outputIndices[${i.length-1}] / ${s}`:"outputIndices[1]"};`;else if(n==="NCHW")k=`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${s}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:w,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:l?[{type:12,data:d},...X(i)]:[{type:12,data:d}]})}},Fo=e=>fe(e),Ep=(e,t)=>{let{inputs:r,outputCount:a}=e,n=Fo({...t,outputCount:a});if(be.webgpu.validateInputContent&&Go(r,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Ho(r,n))}}),Ko,Zo,zp,sg=U(()=>{re(),ie(),Ko=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Zo=e=>{let t=e[0].dims,r=e[0].dims[2],a=C.size(t)/4,n=e[0].dataType,i=R("input",n,t,4),s=R("bias",n,[r],4),u=R("residual",n,t,4),d=H("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:l=>`
  ...
  }`}},zp=e=>{Ko(e.inputs),e.compute(Zo(e.inputs))}}),Qo,ce,Cp,Ap,Op,Bp,Rp,Mp,Dp,Np,Pp,Xo,Up,qp,Wp,Lp,fr,Vp,Gr,jp,Gp,Hp,Fp,Kp,Zp,Qp,Xp,Yp,Jp,ec,tc,rc,ic,ac,nc,Hi,sc,Ba,Ra,oc,uc,lc,Yo,Jo,dc,dn=U(()=>{J(),re(),ve(),ie(),Qo=(e,t,r,a,n,i,s)=>{let u=Math.ceil(t/4),d="";typeof n=="string"?d=`${n}(a)`:d=n("a");let l=R("inputData",r,[u],4),c=H("outputData",a,[u],4),f=[{name:"vec_size",type:"u32"}];return s&&f.push(...s),`
  ...
  }`},ce=(e,t,r,a,n,i=e.dataType,s,u)=>{let d=[{type:12,data:Math.ceil(C.size(e.dims)/4)}];return s&&d.push(...s),{name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:l=>Qo(l,C.size(e.dims),e.dataType,i,r,a,u),getRunData:l=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil(C.size(l[0].dims)/64/4)},programUniforms:d})}},Cp=e=>{e.compute(ce(e.inputs[0],"Abs","abs"))},Ap=e=>{e.compute(ce(e.inputs[0],"Acos","acos"))},Op=e=>{e.compute(ce(e.inputs[0],"Acosh","acosh"))},Bp=e=>{e.compute(ce(e.inputs[0],"Asin","asin"))},Rp=e=>{e.compute(ce(e.inputs[0],"Asinh","asinh"))},Mp=e=>{e.compute(ce(e.inputs[0],"Atan","atan"))},Dp=e=>{e.compute(ce(e.inputs[0],"Atanh","atanh"))},Np=e=>fe(e),Pp=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(ce(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Xo=e=>{let t,r,a=e.length>=2&&e[1].data!==0,n=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=a?e[1].getFloat32Array()[0]:-34028234663852886e22,r=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=a?e[1].getUint16Array()[0]:64511,r=n?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return fe({min:t,max:r})},Up=(e,t)=>{let r=t||Xo(e.inputs),a=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Clip",n=>`clamp(${n}, vec4<${a}>(uniforms.min), vec4<${a}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:a},{name:"max",type:a}]),{inputs:[0]})},qp=e=>{e.compute(ce(e.inputs[0],"Ceil","ceil"))},Wp=e=>{e.compute(ce(e.inputs[0],"Cos","cos"))},Lp=e=>{e.compute(ce(e.inputs[0],"Cosh","cosh"))},fr=e=>fe(e),Vp=(e,t)=>{let r=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Elu",a=>`elu_vf32(${a})`,`
...
}`,jp=e=>{let t=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Gr(t)))},Gp=e=>{e.compute(ce(e.inputs[0],"Exp","exp"))},Hp=e=>{e.compute(ce(e.inputs[0],"Floor","floor"))},Fp=e=>{let t=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Gr(t)))},Kp=(e,t)=>{let r=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"LeakyRelu",a=>`select(leaky_relu_alpha_ * ${a}, ${a}, ${a} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Zp=e=>{e.compute(ce(e.inputs[0],"Not",t=>`!${t}`))},Qp=e=>{e.compute(ce(e.inputs[0],"Neg",t=>`-${t}`))},Xp=e=>{e.compute(ce(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Yp=e=>{let t=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Jp=e=>{e.compute(ce(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},ec=e=>fe(e),tc=(e,t)=>{let r=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"HardSigmoid",a=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${a} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},rc=e=>{e.compute(ce(e.inputs[0],"Sin","sin"))},ic=e=>{e.compute(ce(e.inputs[0],"Sinh","sinh"))},ac=e=>{e.compute(ce(e.inputs[0],"Sqrt","sqrt"))},nc=e=>{e.compute(ce(e.inputs[0],"Tan","tan"))},Hi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,sc=e=>{e.compute(ce(e.inputs[0],"Tanh",Hi))},Ba=(e="f32")=>`
...
`,Ra=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,oc=e=>{let t=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"FastGelu",Ra,Ba(t),void 0,e.inputs[0].dataType))},uc=(e,t)=>{let r=Ae(e.inputs[0].dataType);return e.compute(ce(e.inputs[0],"ThresholdedRelu",a=>`select(vec4<${r}>(0.0), ${a}, ${a} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},lc=e=>{e.compute(ce(e.inputs[0],"Log","log"))},Yo=(e,t)=>`
...
`,Jo=e=>`quick_gelu_impl(${e})`,dc=(e,t)=>{let r=Ae(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"QuickGelu",Jo,Yo(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),eu,tu,pc,og=U(()=>{re(),ie(),dn(),eu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},tu=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=R("input",e[0].dataType,e[0].dims,4),a=R("bias",e[0].dataType,[e[0].dims[2]],4),n=H("output",e[0].dataType,t,4),i=C.size(t)/4,s=ke(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${$}
      }`},iu=(e,t,r,a,n,i,s=r.dataType)=>{let u=r.dims.map(b=>Number(b)??1),d=a.dims.map(b=>Number(b)??1),l=!C.areEqual(u,d),c=u,f=C.size(u),h=!1,g=!1,_=[l];if(l){let b=Gt.calcShape(u,d,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");c=b.slice(),f=C.size(c);let x=C.size(u)===1,$=C.size(d)===1,w=u.length>0&&u[u.length-1]%4===0,k=d.length>0&&d[d.length-1]%4===0;_.push(x),_.push($),_.push(w),_.push(k);let S=1;for(let I=1;I<c.length;I++){let E=u[u.length-I],z=d[d.length-I];if(E===z)S*=E;else break}S%4===0?(g=!0,h=!0):(x||$||w||k)&&(h=!0)}else h=!0;return _.push(h),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>ru(b,u,d,c,h,l,g,n,r.dataType,a.dataType,s,i),getRunData:()=>({outputs:[{dims:c,dataType:s}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(C.size(c)/4)},...X(u,d,c)]})}},Ke=(e,t,r,a,n,i)=>{e.compute(iu(t,n??"",e.inputs[0],e.inputs[1],r,a,i))},cc=e=>{Ke(e,"Add",(t,r)=>`${t}+${r}`)},fc=e=>{Ke(e,"Div",(t,r)=>`${t}/${r}`)},hc=e=>{Ke(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},mc=e=>{Ke(e,"Mul",(t,r)=>`${t}*${r}`)},gc=e=>{let t=R("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Ke(e,"Pow",{scalar:(r,a)=>`pow_custom(${r},${a})`,vector:(r,a)=>`pow_vector_custom(${r},${a})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},_c=e=>{Ke(e,"Sub",(t,r)=>`${t}-${r}`)},yc=e=>{Ke(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},bc=e=>{Ke(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},wc=e=>{Ke(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},$c=e=>{Ke(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}}),au,nu,su,ou,vc,xc,lg=U(()=>{J(),re(),ve(),ie(),au=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,a=e[r],n=a.dataType,i=a.dims.length;e.forEach((s,u)=>{if(u!==r){if(s.dataType!==n)throw new Error("input tensors should be one type");if(s.dims.length!==i)throw new Error("input tensors should have the same shape");s.dims.forEach((d,l)=>{if(l!==t&&d!==a.dims[l])throw new Error("non concat dimensions must match")})}})},nu=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,su=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;++n){let i=t.setByOffset("global_idx",e[n].getByIndices("indices"));r===1?a.push(i):n===0?a.push(`if (inputIndex == ${n}u) { ${i} }`):n===r-1?a.push(`else { ${i} }`):a.push(`else if (inputIndex == ${n}) { ${i} }`)}return a.join(`
`)},ou=(e,t,r,a)=>{let n=C.size(r),i=new Array(e.length),s=new Array(e.length),u=0,d=[],l=[],c=[{type:12,data:n}];for(let b=0;b<e.length;++b)u+=e[b].dims[t],i[b]=u,l.push(e[b].dims.length),s[b]=R(`input${b}`,a,l[b]),d.push("rank"),c.push({type:12,data:i[b]});for(let b=0;b<e.length;++b)c.push(...X(e[b].dims));c.push(...X(r));let f=H("output",a,r.length),h=f.indicesGet("indices",t),g=Array.from(Array(i.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),_=b=>`
  ...
  ${b.mainStart()}
    ...
    ${su(s,f)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:r,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:c}),getShaderSource:_}},vc=(e,t)=>{let r=e.inputs,a=r[0].dims,n=C.normalizeAxis(t.axis,a.length);au(r,n);let i=a.slice();i[n]=r.reduce((u,d)=>u+(d.dims.length>n?d.dims[n]:0),0);let s=r.filter(u=>C.size(u.dims)>0);e.compute(ou(s,n,i,r[0].dataType),{inputs:s})},xc=e=>fe({axis:e.axis})}),Bt,Rt,Mt,pn,Pt=U(()=>{J(),re(),Bt=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Rt=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Mt=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},pn=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[r,a]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:r,beta:a}}else if(t==="Clip"){let[r,a]=(e==null?void 0:e.activation_params)||[Zd,Qd];return{activation:t,clipMax:a,clipMin:r}}else if(t==="LeakyRelu"){let[r]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:r}}return{activation:t}}}),Te,Sc,cn=U(()=>{Te=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Sc=e=>`
...
`}),mr,fn,hn=U(()=>{J(),re(),ie(),Pt(),mr=(e,t,r,a,n)=>{let i=a-r;return`
...
`},fn=(e,t,r,a,n=!1,i)=>{let s=e[0].dims,u=e[1].dims,d=s[s.length-2],l=u[u.length-1],c=s[s.length-1],f=$e(l),h=$e(c),g=$e(d),_=C.size(r)/f/g,b=e.length>2,x=a?a.slice(0,-2):r.slice(0,-2),$=[C.size(x),d,l],w=[{type:12,data:_},{type:12,data:d},{type:12,data:l},{type:12,data:c}];Rt(t,w),w.push(...X(x,s,u)),b&&w.push(...X(e[2].dims)),w.push(...X($));let k=S=>{let I=on("batch_dims",e[0].dataType,x.length),E=R("a",e[0].dataType,s.length,h),z=R("b",e[1].dataType,u.length,f),A=H("output",e[0].dataType,$.length,f),O=ke(A.type.tensor),q=Bt(t,A.type.value,O),K=[E,z],W="";if(b){let ee=n?f:1;K.push(R("bias",e[2].dataType,e[2].dims.length,ee)),W=`${n?`value += bias[col / ${ee}];`:`value += ${A.type.value}(bias[row + i]);`}`}let Z=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Mt(t,Z);let ue=()=>{let ee=`var a_data: ${E.type.value};`;for(let j=0;j<h;j++)ee+=`
...
`}return ee};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${h};${g};${n}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:w}),getShaderSource:k}}}),uu,lu,Ma,Fi,du,Da,pu,Xr,mn=U(()=>{J(),re(),ie(),Pt(),hn(),cn(),uu=(e,t)=>e?`
        ...
        }`,Ma=(e,t,r="f32",a,n=!1,i=32,s=!1,u=32)=>{let d=t[1]*e[1],l=t[0]*e[0],c=n?d:i,f=n?i:d,h=c/t[0],g=i/t[1];if(!((n&&h===4&&e[1]===4||!n&&(h===3||h===4))&&c%t[0]===0&&i%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${n} is true, innerElementSize ${h} and workPerThread[1] ${e[1]} must be 4.
...
`},pu=(e,t,r,a,n=!1)=>{let[i,s,u,d]=a,l=ke(a[0].type.tensor);return`
  ...
  ${b?Ma(x,$,j,ee):Da(x,$,j,ee)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${te}>`:te}) {
      ...
      }`,M=R("x",e[0].dataType,e[0].dims.length,I===3?1:I),P=R("w",e[1].dataType,e[1].dims.length,de),G=[M,P],se=H("result",e[0].dataType,r.length,de);if(s){let Ie=R("bias",e[2].dataType,e[2].dims.length,de);G.push(Ie),ae+=`
        ...
        ${j.registerUniforms(L).declareVariables(...G,se)}
        ${ae}
        ${cu(l,O,q,K,s,t,W[0],W[1],W[2],te)}
        ${b?Ma(k,w,te,void 0,!l,A):Da(k,w,te,void 0,!l,A,!1,void 0,u)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${b};${O};${q};${K};${E};${z};${A}`,inputDependencies:ue},getRunData:()=>({outputs:[{dims:d?d(r):r,dataType:e[0].dataType}],dispatchGroup:{x:S[0],y:S[1],z:S[2]},programUniforms:Z}),getShaderSource:ee}}}),fu,Ki,nr,hu,Zi,mu,Tc,Ec,cg=U(()=>{J(),ct(),re(),ie(),Pt(),cn(),fu=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Ki=e=>typeof e=="number"?[e,e,e]:e,nr=(e,t)=>t<=1?e:e+(e-1)*(t-1),hu=(e,t,r,a=1)=>{let n=nr(t,a);return Math.floor((e[0]*(r-1)-r+n)/2)},Zi=(e,t,r,a,n)=>{n==null&&(n=hu(e,t[0],a[0]));let i=[0,0,0,r];for(let s=0;s<3;s++)e[s]+2*n>=t[s]&&(i[s]=Math.trunc((e[s]-t[s]+2*n)/a[s]+1));return i},mu=(e,t,r,a,n,i,s,u,d,l)=>{let c,f,h,g;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=Zi([t,r,a,1],[u,d,l],1,[n,i,s],e);f=_[0],h=_[1],g=_[2]}else if(Array.isArray(e)){if(!e.every((b,x,$)=>b===$[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=Zi([t,r,a,1],[u,d,l],1,[n,i,s],e[0]);f=_[0],h=_[1],g=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/n),h=Math.ceil(r/i),g=Math.ceil(a/s);let _=(f-1)*n+u-t,b=(h-1)*i+d-r,x=(g-1)*s+l-a,$=Math.floor(_/2),w=_-$,k=Math.floor(b/2),S=b-k,I=Math.floor(x/2),E=x-I;c={top:k,bottom:S,left:I,right:E,front:$,back:w}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:f,outHeight:h,outWidth:g}},Tc=(e,t,r,a,n,i=!1,s="channelsLast")=>{let u,d,l,c,f;if(s==="channelsLast")[u,d,l,c,f]=e;else if(s==="channelsFirst")[u,f,d,l,c]=e;else throw new Error(`Unknown dataFormat ${s}`);let[h,,g,_,b]=t,[x,$,w]=Ki(r),[k,S,I]=Ki(a),E=nr(g,k),z=nr(_,S),A=nr(b,I),{padInfo:O,outDepth:q,outHeight:K,outWidth:W}=mu(n,d,l,c,x,$,w,E,z,A),Z=i?h*f:h,ue=[0,0,0,0,0];return s==="channelsFirst"?ue=[u,Z,q,K,W]:s==="channelsLast"&&(ue=[u,q,K,W,Z]),{batchSize:u,dataFormat:s,inDepth:d,inHeight:l,inWidth:c,inChannels:f,outDepth:q,outHeight:K,outWidth:W,outChannels:Z,padInfo:O,strideDepth:x,strideHeight:$,strideWidth:w,filterDepth:g,filterHeight:_,filterWidth:b,effectiveFilterDepth:E,effectiveFilterHeight:z,effectiveFilterWidth:A,dilationDepth:k,dilationHeight:S,dilationWidth:I,inShape:e,outShape:ue,filterShape:t}},Ec=(e,t,r,a,n,i)=>{let s=i==="channelsLast";s?e[0].dims[3]:e[0].dims[1];let u=[64,1,1],d={x:r.map((x,$)=>$)},l=[Math.ceil(fu(d.x.map(x=>r[x]))/u[0]),1,1];le("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let c=1,f=C.size(r),h=[{type:12,data:f},{type:12,data:a},{type:12,data:n},{type:12,data:t.strides},{type:12,data:t.dilations}];Rt(t,h),h.push(...X(e[0].dims,e[1].dims));let g=["rank","rank"],_=e.length===3;_&&(h.push(...X(e[2].dims)),g.push("rank")),h.push(...X(r));let b=x=>{let $=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:a.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];Mt(t,$);let w=1,k=ke(e[0].dataType),S=R("x",e[0].dataType,e[0].dims.length,c),I=R("W",e[1].dataType,e[1].dims.length,w),E=[S,I],z=H("result",e[0].dataType,r.length,w),A="";if(_){let K=R("bias",e[2].dataType,e[2].dims.length,w);E.push(K),A+=`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:a?a(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:g}),getShaderSource:b}},Cc=(e,t,r,a)=>{let n=e.length>2,i=$e(r[3]),s=$e(r[2]),u=C.size(r)/i/s,d=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/i],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/i],c=[r[0],r[1],r[2],r[3]/i],f=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Rt(t,f),f.push(...X(d,l,c));let h=(s-1)*t.strides[1]+l[1],g=_=>{let b=H("output",e[0].dataType,c.length,i),x=ke(b.type.tensor),$=Bt(t,b.type.value,x),w=R("x",e[0].dataType,d.length,i),k=R("w",e[1].dataType,l.length,i),S=[w,k];n&&S.push(R("b",e[2].dataType,e[2].dims,i));let I=n?"value += b[output_channel];":"",E=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Mt(t,E),`
  ...
  ${_.mainStart()}
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      ${b.set("batch","row","col + i","output_channel","value")};
        ...
        `,c===1)G+=`
          ...
          dotProd = dotProd + xValue * wValue;`;else for(let se=0;se<c;se++)G+=`
            let wValue${se} = ${j.getByOffset(`${j.indicesToOffset(`${j.type.indices}(u32(wRPerm), u32(wCPerm), inputChannel + ${se}, wOutChannel)`)} / ${b}`)};
            dotProd = dotProd + xValue[${se}] * wValue${se};`;return G},M=()=>{if(g===0)return"";if(!f)throw new Error(`packInputAs4 ${f} is not true.`);let G="";if(c===1){G+="dotProd = dotProd";for(let se=0;se<g;se++)G+=`
            + ${L.getByOffset(`x_offset + ${se}`)} * ${j.getByOffset(`w_offset + ${se}`)}`;G+=";"}else if(c===2){if(g!==2)throw new Error(`Invalid inputChannelsRemainder ${g}.`);G+=`
          let xValue = ${L.getByOffset("x_offset")};
          let wValue = ${j.getByOffset("w_offset")};
    ...
    ${P}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${c}${b}${_}${f}${g}`,inputDependencies:w},getRunData:()=>({dispatchGroup:{x:$[0],y:$[1],z:$[2]},outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],programUniforms:A}),getShaderSource:O}}}),wu,$u,vu,Xi,Oc,xu,Yi,Su,Bc,gg=U(()=>{mg(),Pt(),xt(),wu=(e,t,r,a,n,i)=>(e-1)*t+r+(a-1)*n+1-i,$u=(e,t,r,a,n)=>{let i=Math.floor(e/2);t==="SAME_UPPER"?(r[a]=i,r[n]=e-i):t==="SAME_LOWER"&&(r[a]=e-i,r[n]=i)},vu=(e,t,r,a,n,i,s,u,d,l)=>{let c=e.length-2,f=l.length===0;d.length<c&&d.push(...Array(c-d.length).fill(0));let h=e[0],g=t[u?3:1]*n;for(let _=0,b=e.length-c-(u?1:0);_<c;++_,++b){let x=e[b],$=f?x*s[_]:l[_],w=wu(x,s[_],i[_],t[b],r[_],$);$u(w,a,i,_,_+c),f&&l.push(s[_]*(x-1)+d[_]+(t[b]-1)*r[_]+1-i[_]-i[_+c])}l.splice(0,0,h),l.splice(u?3:1,0,g)},Xi=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((f,h)=>f*h,1)===0){r.length=0;for(let f=2;f<t[1].dims.length;++f)r.push(t[1].dims[f])}let a=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(a?3:1,0,t[1].dims[1]);let n=e.pads.slice(),i=e.outputShape.slice(),s=e.outputPadding.slice(),u=t[0].dims,d=e.dilations.slice();if(d.reduce((f,h)=>f+h,0)===0){let f=t[0].dims.length-2;d=new Array(f).fill(1)}let l=e.strides.slice();if(l.reduce((f,h)=>f+h,0)===0){let f=t[0].dims.length-2;l=new Array(f).fill(1)}vu(u,r,d,e.autoPad,e.group,n,l,a,s,i);let c=Object.assign({},e);return Object.assign(c,{kernelShape:r,pads:n,outputPadding:s,outputShape:i,dilations:d,strides:l}),c},Oc=e=>{let t=pn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,i=e.group,s=e.kernelShape,u=e.pads,d=e.strides,l=e.wIsConst(),c=e.outputPadding,f=e.outputShape;return{autoPad:a,format:r,dilations:n,group:i,kernelShape:s,outputPadding:c,outputShape:f,pads:u,strides:d,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},xu=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[0];if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.reduce((s,u)=>s+u,0)>0&&t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.reduce((s,u)=>s+u,0)>0&&t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.reduce((s,u)=>s+u,0)>0&&t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.outputPadding.length!==i&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(t.kernelShape.reduce((s,u)=>s+u,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Yi=(e,t,r,a)=>{let n=e.kernelCustomData.wT??e.compute(Ue(t[1],[2,3,0,1]),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let i=[t[0],n];t.length===3&&i.push(t[2]),e.compute(Ac(i,r,a),{inputs:i})},Su=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let i=t.dilations;(i.length===0||i[0]===0)&&(i=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let u=t.pads;u.length===0&&(u=[0,0]),u=[0,u[0],0,u[1]],s=[1].concat(s),i=[1].concat(i),n=[1].concat(n);let d=t.outputPadding;d=[0].concat(d);let l=Xi({...t,pads:u,strides:s,dilations:i,kernelShape:n,outputPadding:d},a);Yi(e,a,l,c=>r?[c[0],c[2],c[3]]:[c[0],c[1],c[3]])},Bc=(e,t)=>{if(xu(e.inputs,t),e.inputs[0].dims.length===3)Su(e,t);else{let r=Xi(t,e.inputs);Yi(e,e.inputs,r)}}}),ku,Rc,Mc,_g=U(()=>{J(),re(),ve(),ie(),ku=(e,t,r,a)=>{let n=C.size(t),i=t.length,s=R("input",e,i),u=H("output",e,i),d=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),l=C.normalizeAxis(d,i),c=f=>{let h=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,g=F("uniforms.input_shape","uniforms.axis",i),_=a.reverse?h+(a.exclusive?" + 1":""):"0",b=a.reverse?g:h+(a.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:a.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},{type:12,data:l},...X(t,t)]}),getShaderSource:c}},Rc=(e,t)=>{let r=e.inputs[0].dims,a=e.inputs[0].dataType,n=e.inputs[1];e.compute(ku(a,r,n,t),{inputs:[0]})},Mc=e=>{let t=e.exclusive===1,r=e.reverse===1;return fe({exclusive:t,reverse:r})}}),Iu,Tu,Eu,Dc,Nc,yg=U(()=>{J(),re(),ve(),ie(),Iu=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Tu=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let i=0;i<t;++i)n.push(r.indicesSet("a",e[i],`i[${i}]`));return n.push("return a;}"),n.join(`
`)},Eu=(e,t)=>{let r,a,n,i,s,u,d=t.format==="NHWC",l=t.blocksize,c=t.mode==="DCR";d?([r,a,n,i]=e.dims,s=c?[r,a,n,l,l,i/l**2]:[r,a,n,i/l**2,l,l],u=c?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,a,n,i]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],s=c?[r,l,l,i/l**2,a,n]:[r,i/l**2,l,l,a,n],u=c?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let f=e.reshape(s),h=f.dims.length,g=e.dataType,_=R("a",g,h),b=H("output",g,h),x=$=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:$=>{let w=d?[r,a*l,n*l,i/l**2]:[r,i/l**2,a*l,n*l],k=C.size(w),S=f.dims,I=C.sortBasedOnPerm(S,u);return{outputs:[{dims:w,dataType:$[0].dataType}],dispatchGroup:{x:Math.ceil(k/64)},programUniforms:[{type:12,data:k},...X(S,I)]}},getShaderSource:x}},Dc=(e,t)=>{Iu(e.inputs),e.compute(Eu(e.inputs[0],t))},Nc=e=>fe({blocksize:e.blocksize,mode:e.mode,format:e.format})}),qr,sr,Ji,zu,Cu,Au,Ou,ea,Bu,Pc,Uc,bg=U(()=>{J(),re(),ve(),ie(),qr="[a-zA-Z]|\\.\\.\\.",sr="("+qr+")+",Ji="^"+sr+"$",zu="("+sr+",)*"+sr,Cu="^"+zu+"$",Au=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let r=this.symbolToIndices.get(e);r===void 0?r=[t]:r.push(t),this.symbolToIndices.set(e,r)}},Ou=class{constructor(e,t){var n;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[r,a]=t.includes("->")?t.split("->",2):[t,""];if(!r.match(RegExp(Cu)))throw new Error("Invalid LHS term");if(r.split(",").forEach((i,s)=>{let u=e[s].dims.slice();if(!i.match(RegExp(Ji)))throw new Error("Invalid LHS term");let d=this.processTerm(i,!0,u,s);this.lhs.push(d)}),a==="")a+=[...this.symbolToInfo.entries()].filter(([i,s])=>s.count===1||i==="...").map(([i])=>i).join("");else if(!a.match(RegExp(sr)))throw new Error("Invalid RHS");(n=a.match(RegExp(qr,"g")))==null||n.forEach(i=>{if(i==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let s=this.symbolToInfo.get(i);if(s===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(s.dimValue)}}),this.rhs=this.processTerm(a,!1,this.outputDims)}addSymbol(e,t,r){let a=this.symbolToInfo.get(e);if(a!==void 0){if(a.dimValue!==t&&a.count!==1)throw new Error("Dimension mismatch");a.count++,a.inputIndices.push(r)}else a={count:1,dimValue:t,inputIndices:[r]};this.symbolToInfo.set(e,a)}processTerm(e,t,r,a=-1){let n=r.length,i=!1,s=[],u=0;if(!e.match(RegExp(Ji))&&!t&&e!=="")throw new Error("Invalid LHS term");let d=e.match(RegExp(qr,"g")),l=new Au(a);return d==null||d.forEach((c,f)=>{if(c==="..."){if(i)throw new Error("Only one ellipsis is allowed per input term");i=!0;let h=n-d.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(s=r.slice(u,u+h),this.hasEllipsis){if(this.ellipsisDims.length!==s.length||this.ellipsisDims.toString()!==s.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=s;else throw new Error("Ellipsis must be specified in the LHS");for(let g=0;g<s.length;g++){let _=String.fromCharCode(48+g);l.addSymbol(_,f+g),this.addSymbol(_,r[u++],a)}}else l.addSymbol(c,f+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,r[u++],a)}),l}},ea=e=>e+"_max",Bu=(e,t,r,a)=>{let n=e.map(l=>l.length).map((l,c)=>R(`input${c}`,t,l)),i=C.size(a),s=H("output",t,a.length),u=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),d=l=>{let c=[],f="var prod = 1.0;",h="var sum = 0.0;",g="sum += prod;",_=[],b=[],x=[],$=[],w=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((S,I)=>{var E;if(r.rhs.symbolToIndices.has(I)){let z=(E=r.rhs.symbolToIndices.get(I))==null?void 0:E[0];z!==void 0&&r.lhs.forEach((A,O)=>{if(S.inputIndices.includes(O)){let q=A.symbolToIndices.get(I);if(q===void 0)throw new Error("Invalid symbol error");q.forEach(K=>{c.push(`${n[O].indicesSet(`input${O}Indices`,K,s.indicesGet("outputIndices",z))}`)})}})}else r.lhs.forEach((z,A)=>{if(S.inputIndices.includes(A)){let O=z.symbolToIndices.get(I);if(O===void 0)throw new Error("Invalid symbol error");O.forEach(q=>{_.push(`${n[A].indicesSet(`input${A}Indices`,q,`${I}`)}`)}),$.push(`prod *= ${n[A].getByIndices(`input${A}Indices`)};`)}}),b.push(`for(var ${I}: u32 = 0; ${I} < uniforms.${ea(I)}; ${I}++) {`),x.push("}")});let k=w?[...c,`let sum = ${n.map((S,I)=>S.getByIndices(`input${I}Indices`)).join(" * ")};`]:[...c,h,...b,..._,f,...$,g,...x];return`
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=u.filter(f=>r.symbolToInfo.has(f)).map(f=>{var h;return{type:12,data:((h=r.symbolToInfo.get(f))==null?void 0:h.dimValue)||0}});l.push({type:12,data:i});let c=e.map((f,h)=>[...X(f)]).reduce((f,h)=>f.concat(h),l);return c.push(...X(a)),{outputs:[{dims:a,dataType:t}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}},getShaderSource:d}},Pc=(e,t)=>{let r=new Ou(e.inputs,t.equation),a=r.outputDims,n=e.inputs.map((i,s)=>i.dims);e.compute(Bu(n,e.inputs[0].dataType,r,a))},Uc=e=>{let t=e.equation.replace(/\s+/g,"");return fe({equation:t})}}),Ru,ta,Mu,Du,qc,wg=U(()=>{J(),re(),ie(),Ru=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},ta=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},Mu=(e,t)=>e.length>t.length?ta(e,t):ta(t,e),Du=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=Mu(t,r),n=e[0].dataType,i=n===9||C.size(t)===1,s=n===9||t.length>0&&t[t.length-1]%4===0?4:1,u=i||a.length>0&&a[a.length-1]%4===0?4:1,d=Math.ceil(C.size(a)/u),l=f=>{let h=R("input",n,t.length,s),g=H("output",n,a.length,u),_;if(n===9){let b=(x,$,w="")=>`
    ...
    ${_}`},c=[{type:12,data:d},...X(t,a)];return{name:"Expand",shaderCache:{hint:`${a.length};${s}${u}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c})}},qc=e=>{Ru(e.inputs),e.compute(Du(e.inputs),{inputs:[0]})}}),Nu,Wc,$g=U(()=>{J(),re(),ie(),dn(),Nu=e=>{let t=e[0].dataType,r=C.size(e[0].dims),a=C.size(e[1].dims),n=a%4===0,i=s=>{let u=R("x",t,[1],4),d=R("bias",t,[1],4),l=H("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=g=>`
    ...
    ${s.mainStart(Ht)}
      ...
      ${h.mainStart()}
        ...
        ${$}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:f}},Lc=e=>fe({axis:e.axis}),Vc=(e,t)=>{let r=e.inputs;Pu(r),e.compute(Uu(e.inputs,t))}}),qu,jc,Gc,xg=U(()=>{J(),re(),ie(),qu=(e,t,r,a,n,i,s,u,d)=>{let l=[{type:12,data:i},{type:12,data:a},{type:12,data:n},{type:12,data:r},{type:12,data:s},{type:12,data:u},{type:12,data:d}],c=[i];l.push(...X(t.dims,c));let f=h=>{let g=R("indices_data",t.dataType,t.dims.length),_=H("input_slice_offsets_data",12,1,1),b=[g,_],x=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:n.length},{name:"sizes_from_slice_dims_data",type:"u32",length:r.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${h.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((g,_)=>_!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(g,_)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:l}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:h}},Hc=(e,t)=>{let r=e.inputs;Wu(r,t),e.compute(Lu(e.inputs,t))},Fc=e=>fe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Vu,ju,Kc,Zc,kg=U(()=>{J(),re(),ve(),ie(),Vu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},ju=(e,t)=>{let r=e[0].dims,a=e[0].dataType,n=r.length,i=e[1].dims,s=e[1].dataType,u=C.normalizeAxis(t.axis,n),d=r[u],l=i.slice(0),c=C.size(l),f=R("input",a,n),h=R("indicesInput",s,i.length),g=H("output",a,l.length),_=[{type:12,data:c},{type:6,data:d},{type:12,data:u}];return _.push(...X(r,i,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:_}),getShaderSource:b=>`
  ...
  }`};return f?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:l*c},programUniforms:g}),getShaderSource:x}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:g}),getShaderSource:b}},Qc=e=>{let t=e.transA,r=e.transB,a=e.alpha,n=e.beta;return{transA:t,transB:r,alpha:a,beta:n,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Xc=(e,t)=>{Gu(e.inputs),e.compute(Hu(e.inputs,t))}}),at,ut,Tt,Et,Fu,Ku,Zu,Qu,Xu,Yu,Ju,el,Yc,Jc,Tg=U(()=>{J(),re(),ve(),ie(),[at,ut,Tt,Et]=[0,1,2,3],Fu=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Ku=`
...
`,Ju=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${r.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,el=(e,t)=>{let r=R("x",e[0].dataType,e[0].dims.length),a=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],n=R("grid",e[1].dataType,a.length,2),i=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(i=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[at,ut,Tt,Et]=[0,3,1,2]);let s=H("output",e[0].dataType,i.length),u=r.type.value,d=C.size(i),l=[{type:12,data:d},...X(e[0].dims,a,i)],c=f=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:l}),getShaderSource:c},{inputs:[t,r],outputs:[-1]})[0]},hr=(e,t,r,a,n,i,s,u)=>{let d=i;if(s&&C.size(s.dims)>0){if(a===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return d=rl(e,i,s,t,a,r*n,u),d=d.reshape([t,a,r,n]),r===1||a===1?d:e.compute(Ue(d,ra.perm),{inputs:[d],outputs:[-1]})[0]}else return i.dims.length===3&&(d=i.reshape([t,a,r,n])),r===1||a===1?d:e.compute(Ue(d,ra.perm),{inputs:[d],outputs:[-1]})[0]},tf=(e,t)=>{let r=tl(e.inputs,t),a=e.inputs[0],n=Oe(e.inputs,1),i=Oe(e.inputs,2),s=Oe(e.inputs,3),u=Oe(e.inputs,4),d=Oe(e.inputs,5),l=Oe(e.inputs,6),c=Oe(e.inputs,7);if(a.dims.length===5)throw new Error("Packed QKV is not implemented");if((n==null?void 0:n.dims.length)===5)throw new Error("Packed KV is not implemented");let f=n&&i&&n.dims.length===4&&i.dims.length===4,h=hr(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,a,s,0);if(f)return _r(e,h,n,i,u,void 0,l,c,d,r);if(!n||!i)throw new Error("key and value must be provided");let g=hr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,n,s,r.hiddenSize),_=hr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,i,s,2*r.hiddenSize);_r(e,h,g,_,u,void 0,l,c,d,r)}}),il,al,nl,sl,Ua,af,nf,sf=U(()=>{J(),re(),ve(),ie(),il=e=>{if(!e||e.length<1)throw new Error("too few inputs")},al=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),fe({numOutputs:a,axis:t.axis,splitSizes:r})},nl=e=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:i},getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:l}},lf=(e,t)=>{var S;let r=ul(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((S=e.inputs[1])==null?void 0:S.dims.length)===5)throw new Error("Packed KV is not implemented");let a=e.inputs[0],n=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,i=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,s=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,u=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,d=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,c=r.kvNumHeads?r.kvNumHeads:r.numHeads,f=fe({axis:2,numOutputs:3,splitSizes:[r.numHeads*r.headSize,c*r.headSize,c*r.headSize]}),[h,g,_]=!n&&!i?e.compute(Ua([a],f),{inputs:[a],outputs:[-1,-1,-1]}):[a,n,i],b,x;if(t.doRotary){let I=e.compute(dl(r.batchSize,r.sequenceLength,d,l),{inputs:[d,l],outputs:[-1]})[0],E=e.inputs[7],z=e.inputs[8],A=fe({interleaved:t.rotaryInterleaved!==0,numHeads:r.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),O=[h,I,E,z],q=[-1];b=e.compute(Yr(O,A),{inputs:O,outputs:q})[0],O.splice(0,1,g);let K=fe({interleaved:t.rotaryInterleaved!==0,numHeads:r.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});x=e.compute(Yr(O,K),{inputs:O,outputs:q})[0]}let $=hr(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,t.doRotary?b:h,void 0,0),w=ia(e,t.doRotary?x:g,r),k=ia(e,_,r);_r(e,$,w,k,void 0,void 0,s,u,void 0,r,d,l)}}),aa,pl,cl,df,zg=U(()=>{J(),re(),xt(),ie(),aa=(e,t,r,a,n,i,s,u)=>{let d=$e(i),l=d===1?"f32":`vec${d}f`,c=d===1?"vec2f":`mat2x${d}f`,f=n*s,h=64;f===1&&(h=256);let g=[n,s,i/d],_=[n,s,2],b=["rank","type","type"],x=[];x.push(...X(g,_));let $=w=>{let k=R("x",t.dataType,3,d),S=R("scale",r.dataType,r.dims),I=R("bias",a.dataType,a.dims),E=H("output",1,3,2),z=[k,S,I,E];return`
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...X(h,g,h)]}),getShaderSource:b},{inputs:[t[0],f]})},cl=(e,t,r)=>{let a=t[0].dims,n=a,i=a[0],s=a[a.length-1],u=C.sizeFromDimension(a,1)/s,d=$e(s),l=C.size(n)/d,c=[{type:12,data:u},{type:12,data:Math.floor(s/d)}],f=["type","type"],h=!1,g=[0,a.length-1];for(let $=0;$<a.length-2;$++)h=h||a[$+1]!==1,g.push($+1);h=h&&a[a.length-1]!==1;let _=h?e.compute(Ue(e.inputs[0],g),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:a.length},($,w)=>a[g[w]])),b=aa(e,_,t[1],t[2],i,u,s,r.epsilon),x=$=>{let w=ke(t[0].dataType),k=d===1?"vec2f":`mat${d}x2f`,S=z=>{let A=z===0?"x":"y",O=d===1?"f32":`vec${d}f`;switch(d){case 1:return`${w}(${O}(scale.${A}))`;case 2:return`vec2<${w}>(${O}(scale[0].${A}, scale[1].${A}))`;case 4:return`vec4<${w}>(${O}(scale[0].${A}, scale[1].${A}, scale[2].${A}, scale[3].${A}))`;default:throw new Error(`Not supported compoents ${d}`)}},I=R("input",t[0].dataType,t[0].dims,d),E=H("output",t[0].dataType,n,d);return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${d}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:x},{inputs:[t[0],b]})},df=(e,t)=>{t.format==="NHWC"?cl(e,e.inputs,t):pl(e,e.inputs,t)}}),fl,hl,pf,Cg=U(()=>{J(),re(),ie(),fl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},hl=(e,t,r)=>{let a=t.simplified,n=e[0].dims,i=e[1],s=!a&&e[2],u=n,d=C.normalizeAxis(t.axis,n.length),l=C.sizeToDimension(n,d),c=C.sizeFromDimension(n,d),f=C.size(i.dims),h=s?C.size(s.dims):0;if(f!==c||s&&h!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  ${I.mainStart()}
    ...
    ${w?"inv_std_output[global_idx] = inv_std_dev":""};
          ...
          `;for(let P=0;P<g*b;P++)M+=`
            ...
            b_quantized_values = ${L}(${Array.from({length:4},(G,se)=>`${j}(b_value_lower[${se}]), ${j}(b_value_upper[${se}])`).join(", ")});
            b_dequantized_values = ${f===1?`${L}(${Array.from({length:8},(G,se)=>`(b_quantized_values[${se}] - ${Z?`zero_point${P}`:"zero_point"}) * scale${P}`).join(", ")});`:`(b_quantized_values - ${L}(${Array(8).fill(`${Z?`zero_point${P}`:"zero_point"}`).join(",")})) * scale${P};`};
            workgroup_shared[local_id.x * ${b} + ${Math.floor(P/g)}]${g>1?`[${P%g}]`:""} += ${Array.from({length:8/f},(G,se)=>`${f===1?`a_data[${se}] * b_dequantized_values[${se}]`:`dot(a_data[${se}], b_dequantized_values[${se}])`}`).join(" + ")};
          `;return M},te=()=>{let M=`
            var col_index = col * ${g};
            ${Z?`
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${f};${h};${x};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:g,dataType:c}],dispatchGroup:{x:S},programUniforms:I}),getShaderSource:O}},ff=(e,t)=>{gl(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(yl(e.inputs,t)):e.compute(_l(e.inputs,t))},hf=e=>fe(e)}),bl,wl,$l,vl,xl,Sl,kl,Il,mf,Bg=U(()=>{J(),re(),ie(),bl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},wl=(e,t,r)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
      ...
      `},$l=(e,t,r)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
                k = i32(${e.indicesGet("indices",n)}) - ${F("uniforms.pads",n,r)};
                if (k < 0) {
                  k = -k;
                }
            ...
            `;return`
              ...
              ${a}
              value = x[offset];
          `},vl=(e,t,r)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
                k = i32(${e.indicesGet("indices",n)}) - ${F("uniforms.pads",n,r)};
                if (k < 0) {
                  k = 0;
                }
          ...
          `},xl=(e,t,r)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
            ...
            `;return`
              ...
              ${a}
              value = x[offset];
          `},Sl=(e,t,r)=>{switch(r.mode){case 0:return wl(e,t,r.pads.length);case 1:return $l(e,t,r.pads.length);case 2:return vl(e,t,r.pads.length);case 3:return xl(e,t,r.pads.length);default:throw new Error("Invalid mode")}},kl=(e,t)=>{let r=C.padShape(e[0].dims.slice(),t.pads),a=e[0].dims,n=C.size(r),i=[{type:12,data:n},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&i.push({type:s?e[2].dataType:1,data:t.value}),i.push(...X(e[0].dims,r));let u=["rank"],d=l=>{let c=H("output",e[0].dataType,r.length),f=R("x",e[0].dataType,a.length),h=f.type.value,g=Sl(c,a.length,t),_=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&_.push({name:"constant_value",type:s?h:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},ua=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Tl=e=>`${ua(e)};${e.countIncludePad}`,El=e=>`${ua(e)};${e.storageOrder};${e.dilations}`,la=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),da=(e,t,r,a)=>{let[n,i]=na(t,a,r),s=R("x",t.dataType,t.dims.length),u=s.type.value,d="value += x_val;",l="";n.countIncludePad?l+=`value /= ${u}(uniforms.kernelSize);`:l+=`value /= ${u}(i32(uniforms.kernelSize) - pad);`;let[c,f,h,g,_]=sa(i,n);c.push(...X(t.dims,i));let b=["rank"];return{name:e,shaderCache:{hint:`${a.cacheKey};${h};${g};${_}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(C.size(i)/64)},programUniforms:c}),getShaderSource:x=>oa(x,s,t.dims.length,i.length,n,d,l,0,f,h,g,_)}},gf=e=>{let t=e.count_include_pad!==0,r=la(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let a={countIncludePad:t,...r,cacheKey:""};return{...a,cacheKey:Tl(a)}},_f=(e,t)=>{or(e.inputs),e.compute(da("AveragePool",e.inputs[0],!1,t))},pa={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},yf=e=>{let t=e.format;return{format:t,...pa,cacheKey:t}},bf=(e,t)=>{or(e.inputs),e.compute(da("GlobalAveragePool",e.inputs[0],!0,t))},ca=(e,t,r,a)=>{let[n,i]=na(t,a,r),s=`
      value = max(x_val, value);
    `,u="",d=R("x",t.dataType,t.dims.length),l=["rank"],[c,f,h,g,_]=sa(i,n);return c.push(...X(t.dims,i)),{name:e,shaderCache:{hint:`${a.cacheKey};${h};${g};${_}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(C.size(i)/64)},programUniforms:c}),getShaderSource:b=>oa(b,d,t.dims.length,i.length,n,s,u,t.dataType===10?-65504:-1e5,f,h,g,_)}},wf=(e,t)=>{or(e.inputs),e.compute(ca("MaxPool",e.inputs[0],!1,t))},$f=e=>{let t=e.storage_order,r=e.dilations,a=la(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:r,...a,cacheKey:""};return{...n,cacheKey:El(n)}},vf=e=>{let t=e.format;return{format:t,...pa,cacheKey:t}},xf=(e,t)=>{or(e.inputs),e.compute(ca("GlobalMaxPool",e.inputs[0],!0,t))}}),zl,Cl,Sf,kf,Mg=U(()=>{J(),re(),ve(),ie(),zl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,a)=>r===e[2].dims[a]).reduce((r,a)=>r&&a,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,i)=>i===t.axis||n===e[0].dims[i]).reduce((n,i)=>n&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],a=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/a)||t.blockSize>Math.ceil(r/(a-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Cl=(e,t)=>{let r=C.normalizeAxis(t.axis,e[0].dims.length),a=e[0].dataType,n=a===3,i=e[0].dims,s=e[1].dataType,u=C.size(i),d=a===3||a===2,l=d?[Math.ceil(C.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,f=e.length>2?e[2]:void 0,h=f?d?[Math.ceil(C.size(f.dims)/4)]:f.dims:void 0,g=c.length===0||c.length===1&&c[0]===1,_=g===!1&&c.length===1,b=$e(u),x=g&&(!d||b===4),$=x?b:1,w=x&&!d?b:1,k=R("input",d?12:a,l.length,w),S=R("scale",s,c.length),I=f?R("zero_point",d?12:a,h.length):void 0,E=H("output",s,i.length,$),z=[k,S];I&&z.push(I);let A=[l,c];f&&A.push(h);let O=[{type:12,data:u/$},{type:12,data:r},{type:12,data:t.blockSize},...X(...A,i)],q=K=>{let W=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:q,getRunData:()=>({outputs:[{dims:i,dataType:s}],dispatchGroup:{x:Math.ceil(u/$/64),y:1,z:1},programUniforms:O})}},Sf=(e,t)=>{zl(e.inputs,t),e.compute(Cl(e.inputs,t))},kf=e=>fe({axis:e.axis,blockSize:e.blockSize})}),Al,Ol,If,Dg=U(()=>{Je(),J(),ie(),Al=(e,t,r)=>{let a=e===t,n=e<t&&r<0,i=e>t&&r>0;if(a||n||i)throw new Error("Range these inputs' contents are invalid.")},Ol=(e,t,r,a)=>{let n=Math.abs(Math.ceil((t-e)/r)),i=[n],s=n,u=[{type:12,data:s},{type:a,data:e},{type:a,data:r},...X(i)],d=l=>{let c=H("output",a,i.length),f=c.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${l.registerUniforms(h).declareVariables(c)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${a}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},If=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),be.webgpu.validateInputContent&&Al(t,r,a),e.compute(Ol(t,r,a,e.inputs[0].dataType),{inputs:[]})}}),Bl,fa,ha,Rl,Tf,Ef,Ng=U(()=>{J(),re(),ve(),ie(),Bl=(e,t,r,a)=>{if(e!=="none"&&a!=="i32"&&a!=="u32"&&a!=="f32")throw new Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,i=`;
    ...
    data_offset += u32((u32(index) * element_count_dim));`,ha=(e,t,r)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
      ...
      }`,Rl=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r,i=1,s=Math.ceil(C.size(a)/i),u=a[a.length-1],d=C.sizeFromDimension(r,u),l=C.sizeFromDimension(a,0)/u,c=[{type:12,data:s},{type:12,data:u},{type:12,data:d},...X(e[1].dims,e[2].dims,n)],f=h=>{let g=R("indices",e[1].dataType,e[1].dims.length),_=R("updates",e[2].dataType,e[2].dims.length,i),b=t.reduction!=="none"&&t.reduction!==""?tp("output",e[0].dataType,n.length):H("output",e[0].dataType,n.length,i);return`
  ...
  ${ha(t,b.type.value,!0)}
  }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:c}),getShaderSource:f}},Tf=e=>fe({reduction:e.reduction}),Ef=(e,t)=>{e.compute(Rl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Ml,Dl,Nl,ma,Pl,Ul,ql,Wl,Ll,Vl,jl,Gl,ga,Hl,Fl,Kl,Zl,Ql,zf,Cf,Pg=U(()=>{J(),re(),ve(),ie(),Ml=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},Dl=(e,t,r)=>{t.every(n=>n>=0&&n<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let a=new Array(r).fill(1);return t.forEach((n,i)=>a[n]=e[i]),a},Nl=(e,t,r,a,n,i)=>{let[s,u,d]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],l=e[0].dims.length;if(s>0&&e.length>s&&e[s].dims.length>0)e[s].getFloat32Array().forEach(c=>i.push(c));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0){if(e[u].getFloat32Array().forEach(c=>a.push(c)),a.length!==0&&a.length!==l&&r>=18&&a.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");Ml(a,t),t.axes.length>0&&Dl(a,t.axes,l).forEach((c,f)=>a[f]=c)}if(d>0&&e.length>d&&e[d].dims.length===1&&e[d].dims[0]>0&&(e[d].getBigInt64Array().forEach(c=>n.push(Number(c))),n.length!==0&&n.length!==l&&r>=18&&n.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(a.length!==0&&a.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==0&&n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof a<"u"&&typeof n<"u"&&a.length>0&&n.length>l)throw new Error("Resize requires only of scales or sizes to be specified")},ma=(e,t,r,a)=>`
...
`,Pl=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Ul=(e,t,r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",ql=(e,t,r)=>{let a=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((i,s)=>{a[i]=n[s],a[s+r]=n[t.length+s]}),a):n},Wl=(e,t,r,a)=>{let n=[];if(r.length>0)if(a.length>0){if(e.forEach(i=>n.push(i)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((i,s)=>n[i]=r[s])}else r.forEach(i=>n.push(i));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((i,s)=>Math.round(i*t[s]))}return n},Ll=(e,t,r)=>{let a=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(i=>t[i]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(i=>t[i]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return r.axes.length>0?(r.axes.forEach(i=>t[i]=a),r.axes.forEach(i=>n[i]=Math.round(e[i]*t[i]))):(t.fill(a,0,t.length),n.forEach((i,s)=>n[s]=Math.round(i*t[s]))),n},Vl=(e,t,r,a,n)=>`
...
`:"",Hl=(e,t,r,a,n)=>{let[i,s,u,d]=r.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},Fl=(e,t,r,a,n,i,s,u,d,l)=>{let c=r.length===2,[f,h]=c?[0,1]:[2,3],g=e.type.value,_=b=>{let x=b===f?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    }`},Zl=(e,t,r,a,n,i)=>{let s=e.dims,u=ql(i,t.axes,s.length),d=Wl(s,a,n,t.axes),l=a.slice();a.length===0&&(l=s.map((w,k)=>w===0?1:d[k]/w),t.keepAspectRatioPolicy!=="stretch"&&(d=Ll(s,l,t)));let c=H("output",e.dataType,d.length),f=R("input",e.dataType,s.length),h=C.size(d),g=s.length===d.length&&s.every((w,k)=>w===d[k]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,x=f.type.value,$=w=>`
      ${g?"":`
      ${Pl(t.coordinateTransformMode,x)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${Gl(f,s)};
              ${Ul(t.nearestMode,r,x)};
              ${jl(f,c,s,d,l.length,u.length,_)};
              `;case"linear":return`
              ${Vl(c,s,d,l.length,u.length)};
              ${(()=>{if(s.length===2||s.length===4)return`${Hl(f,c,s,_,b)}`;if(s.length===3||s.length===5)return`${Kl(f,c,s,_,b)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(s.length===2||s.length===4)return`${Fl(f,c,s,d,l,u,t.cubicCoeffA,_,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`},S=[{dims:u,dataType:e[0].dataType}];return r>1&&S.push({dims:c,dataType:1}),r>2&&S.push({dims:c,dataType:1}),r>3&&S.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${$};${g};${_};${b}`,inputDependencies:e.map((I,E)=>"type")},getShaderSource:k,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(d/l)},programUniforms:w})}},Af=(e,t)=>{Xl(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Yl(e.inputs,t,e.outputCount,!1),{outputs:r})}}),Jl,ur,ed,_a,td,rd,Of,Bf,qg=U(()=>{J(),re(),ve(),ie(),Jl=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},ur=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},ed=(e,t)=>{if(e.length>1){let r=ur(e,1),a=ur(e,2),n=ur(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),fe({starts:r,ends:a,axes:n})}else return t},_a=(e,t,r,a,n)=>{let i=e;return e<0&&(i+=r[a[t]]),n[t]<0?Math.max(0,Math.min(i,r[a[t]]-1)):Math.max(0,Math.min(i,r[a[t]]))},td=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${d.length}_${s.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:x,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:b})}},Of=(e,t)=>{Jl(e.inputs,t);let r=ed(e.inputs,t);e.compute(rd(e.inputs,r),{inputs:[0]})},Bf=e=>{let t=e.starts,r=e.ends,a=e.axes;return fe({starts:t,ends:r,axes:a})}}),id,ad,Rf,Mf,Wg=U(()=>{J(),re(),ve(),xt(),ie(),id=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},ad=(e,t)=>{let r=e.inputs[0],a=r.dims,n=C.size(a),i=a.length,s=C.normalizeAxis(t.axis,i),u=s<a.length-1,d,l=[];u?(l=Array.from({length:i},(z,A)=>A),l[s]=i-1,l[i-1]=s,d=e.compute(Ue(r,l),{inputs:[r],outputs:[-1]})[0]):d=r;let c=d.dims,f=c[i-1],h=n/f,g=$e(f),_=f/g,b=64;h===1&&(b=256);let x=(z,A)=>A===4?`max(max(${z}.x, ${z}.y), max(${z}.z, ${z}.w))`:A===2?`max(${z}.x, ${z}.y)`:A===3?`max(max(${z}.x, ${z}.y), ${z}.z)`:z,$=R("x",d.dataType,d.dims,g),w=H("result",d.dataType,d.dims,g),k=$.type.value,S=ke(d.dataType)==="f32"?`var threadMax = ${k}(-3.402823e+38f);`:`var threadMax = ${k}(-65504.0h);`,I=z=>`
      ...
      }`,E=e.compute({name:"Softmax",shaderCache:{hint:`${g};${b}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:c,dataType:d.dataType}],dispatchGroup:{x:h},programUniforms:[{type:6,data:_}]}),getShaderSource:I},{inputs:[d],outputs:[u?-1:0]})[0];u&&e.compute(Ue(E,l),{inputs:[E]})},Rf=(e,t)=>{id(e.inputs),ad(e,t)},Mf=e=>fe({axis:e.axis})}),ya,nd,sd,od,Df,Lg=U(()=>{J(),re(),ie(),ya=e=>Array.from(e.getBigInt64Array(),Number),nd=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, float16, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(ya(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},sd=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},od=(e,t)=>{let r=e[0].dims,a=t??ya(e[1]),n=sd(r,a),i=C.size(n),s=e[0].dataType,u=R("input",s,r.length),d=H("output",s,n.length),l=c=>`
      ...
      ${d.setByOffset("global_idx",u.getByIndices("input_indices"))}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${l}
      }`},ld=e=>{let t=e[1].dims,r=e[2].dims,a=e[0].dims,n=e[1].dataType,i=!(C.areEqual(t,r)&&C.areEqual(r,a)),s=t,u=C.size(t);if(i){let l=Gt.calcShape(Gt.calcShape(t,r,!1),a,!1);if(!l)throw new Error("Can't perform where op on the given tensors");s=l,u=C.size(s)}let d=Math.ceil(u/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:l=>ud(l,e,s,i,n),getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(u/64/4)},programUniforms:[{type:12,data:d},...X(a,t,r,s)]})}},Nf=e=>{e.compute(ld(e.inputs))}}),Pf,jg=U(()=>{ag(),ln(),ng(),sg(),og(),ug(),lg(),hg(),gg(),_g(),yg(),bg(),wg(),$g(),vg(),xg(),Sg(),kg(),Ig(),Tg(),Eg(),zg(),Cg(),Ag(),Og(),rf(),Bg(),Rg(),Mg(),Dg(),Ng(),un(),Pg(),uf(),Ug(),qg(),Wg(),sf(),Lg(),xt(),dn(),Vg(),Pf=new Map([["Abs",[Cp]],["Acos",[Ap]],["Acosh",[Op]],["Add",[cc]],["ArgMax",[Ip,Oa]],["ArgMin",[kp,Oa]],["Asin",[Bp]],["Asinh",[Rp]],["Atan",[Mp]],["Atanh",[Dp]],["Attention",[Tp]],["AveragePool",[_f,gf]],["BatchNormalization",[Ep]],["BiasAdd",[zp]],["BiasSplitGelu",[pc]],["Cast",[Pp,Np]],["Ceil",[qp]],["Clip",[Up]],["Concat",[vc,xc]],["Conv",[Pa,Na]],["ConvTranspose",[Bc,Oc]],["Cos",[Wp]],["Cosh",[Lp]],["CumSum",[Rc,Mc]],["DepthToSpace",[Dc,Nc]],["DequantizeLinear",[Sf,kf]],["Div",[fc]],["Einsum",[Pc,Uc]],["Elu",[Vp,fr]],["Equal",[hc]],["Erf",[jp]],["Exp",[Gp]],["Expand",[qc]],["FastGelu",[Wc]],["Floor",[Hp]],["FusedConv",[Pa,Na]],["Gather",[Vc,Lc]],["GatherElements",[Zc,Kc]],["GatherBlockQuantized",[Hc,Fc]],["GatherND",[jc,Gc]],["Gelu",[Fp]],["Gemm",[Xc,Qc]],["GlobalAveragePool",[bf,yf]],["GlobalMaxPool",[xf,vf]],["Greater",[yc]],["GreaterOrEqual",[wc]],["GridSample",[Yc,Jc]],["GroupQueryAttention",[lf]],["HardSigmoid",[tc,ec]],["InstanceNormalization",[df]],["LayerNormalization",[pf]],["LeakyRelu",[Kp,fr]],["Less",[bc]],["LessOrEqual",[$c]],["Log",[lc]],["MatMul",[cf]],["MatMulNBits",[ff,hf]],["MaxPool",[wf,$f]],["Mul",[mc]],["MultiHeadAttention",[tf,ef]],["Neg",[Qp]],["Not",[Zp]],["Pad",[mf]],["Pow",[gc]],["QuickGelu",[dc,fr]],["Range",[If]],["Reciprocal",[Xp]],["ReduceMin",[wp]],["ReduceMean",[mp]],["ReduceMax",[bp]],["ReduceSum",[vp]],["ReduceProd",[$p]],["ReduceL1",[gp]],["ReduceL2",[_p]],["ReduceLogSum",[Sp]],["ReduceLogSumExp",[yp]],["ReduceSumSquare",[xp]],["Relu",[Yp]],["Resize",[zf,Cf]],["RotaryEmbedding",[of]],["ScatterND",[Ef,Tf]],["Sigmoid",[Jp]],["Sin",[rc]],["Sinh",[ic]],["Slice",[Of,Bf]],["SkipLayerNormalization",[Af]],["Split",[af,nf]],["Sqrt",[ac]],["Softmax",[Rf,Mf]],["Sub",[_c]],["Tan",[nc]],["Tanh",[sc]],["ThresholdedRelu",[uc,fr]],["Tile",[Df]],["Transpose",[ip,ap]],["Where",[Nf]]])}),Uf,Gg=U(()=>{Je(),ct(),ie(),Uf=class{constructor(e){this.backend=e,this.repo=new Map,this.attributesBound=!1}getArtifact(e){return this.repo.get(e)}setArtifact(e,t){this.repo.set(e,t)}run(e,t,r,a,n){nt(e.programInfo.name);let i=this.backend.device,s=this.backend.getComputePassEncoder();this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2);let u=[];for(let l of t)u.push({binding:u.length,resource:{buffer:l.buffer}});for(let l of r)u.push({binding:u.length,resource:{buffer:l.buffer}});n&&u.push({binding:u.length,resource:n});let d=i.createBindGroup({layout:e.computePipeline.getBindGroupLayout(0),entries:u,label:e.programInfo.name});if(this.backend.sessionStatus==="capturing"){let l={kernelId:this.backend.currentKernelId,computePipeline:e.computePipeline,bindGroup:d,dispatchGroup:a};this.backend.capturedCommandList.get(this.backend.currentSessionId).push(l)}s.setPipeline(e.computePipeline),s.setBindGroup(0,d),s.dispatchWorkgroups(...a),this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2+1),this.backend.pendingDispatchNumber++,(this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber||this.backend.queryType==="at-passes")&&this.backend.endComputePass(),this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber&&this.backend.flush(),Qe(e.programInfo.name)}dispose(){}build(e,t){nt(e.name);let r=this.backend.device,a=[];[{feature:"shader-f16",extension:"f16"},{feature:"subgroups",extension:"subgroups"}].forEach(l=>{r.features.has(l.feature)&&a.push(`enable ${l.extension};`)});let n=rp(t,this.backend.device.limits),i=e.getShaderSource(n),s=`${a.join(`
`)}
${n.additionalImplementations}
${i}`,u=r.createShaderModule({code:s,label:e.name});le("verbose",()=>`[WebGPU] ${e.name} shader code: ${s}`);let d=r.createComputePipeline({compute:{module:u,entryPoint:"main"},layout:"auto",label:e.name});return Qe(e.name),{programInfo:e,computePipeline:d,uniformVariablesInfo:n.variablesInfo}}normalizeDispatchGroupSize(e){let t=typeof e=="number"?e:e.x,r=typeof e=="number"?1:e.y||1,a=typeof e=="number"?1:e.z||1,n=this.backend.device.limits.maxComputeWorkgroupsPerDimension;if(t<=n&&r<=n&&a<=n)return[t,r,a];let i=t*r*a,s=Math.ceil(Math.sqrt(i));if(s>n){if(s=Math.ceil(Math.cbrt(i)),s>n)throw new Error("Total dispatch size exceeds WebGPU maximum.");return[s,s,s]}else return[s,s,1]}}}),qf={};Ft(qf,{WebGpuBackend:()=>Wf});var dd,pd,cd,Wf,Hg=U(()=>{Je(),J(),ct(),Xd(),rg(),jg(),Gg(),dd=(e,t)=>{if(t.length!==e.length)throw new Error(`inputDependencies length ${t.length} is not equal to inputTensors length ${e.length}.`);let r=[];for(let a=0;a<e.length;++a){let n=e[a].dataType;switch(t[a]){case"none":{r.push("");break}case"type":{r.push(`${n}`);break}case"rank":{let i=e[a].dims.length;r.push(`${n};${i}`);break}case"dims":{let i=e[a].dims.join(",");r.push(`${n};${i}`);break}default:throw new Error(`unsupported input dependency: ${t[a]}`)}}return r.join("|")},pd=(e,t,r)=>{var n,i;let a=e.name;return(n=e.shaderCache)!=null&&n.hint&&(a+="["+e.shaderCache.hint+"]"),a+=":"+r+`:${dd(t,((i=e.shaderCache)==null?void 0:i.inputDependencies)??new Array(t.length).fill("dims"))}`,a},cd=class{constructor(e){e&&(this.architecture=e.architecture,this.vendor=e.vendor)}isArchitecture(e){return this.architecture===e}isVendor(e){return this.vendor===e}},Wf=class{constructor(){this.currentSessionId=null,this.currentKernelId=null,this.commandEncoder=null,this.computePassEncoder=null,this.maxDispatchNumber=16,this.pendingDispatchNumber=0,this.pendingKernels=[],this.pendingQueries=new Map,this.sessionStatus="default",this.capturedCommandList=new Map,this.capturedPendingKernels=new Map,this.sessionExternalDataMapping=new Map}get currentKernelCustomData(){if(this.currentKernelId===null)throw new Error("currentKernelCustomData(): currentKernelId is null. (should not happen)");let e=this.kernelCustomData.get(this.currentKernelId);return e||(e={},this.kernelCustomData.set(this.currentKernelId,e)),e}async initialize(e,t){this.env=e;let r=[],a={requiredLimits:{maxComputeWorkgroupStorageSize:t.limits.maxComputeWorkgroupStorageSize,maxComputeWorkgroupsPerDimension:t.limits.maxComputeWorkgroupsPerDimension,maxStorageBufferBindingSize:t.limits.maxStorageBufferBindingSize,maxBufferSize:t.limits.maxBufferSize,maxComputeInvocationsPerWorkgroup:t.limits.maxComputeInvocationsPerWorkgroup,maxComputeWorkgroupSizeX:t.limits.maxComputeWorkgroupSizeX,maxComputeWorkgroupSizeY:t.limits.maxComputeWorkgroupSizeY,maxComputeWorkgroupSizeZ:t.limits.maxComputeWorkgroupSizeZ},requiredFeatures:r},n=i=>t.features.has(i)&&r.push(i)&&!0;n("chromium-experimental-timestamp-query-inside-passes")||n("timestamp-query"),n("shader-f16"),n("subgroups"),this.device=await t.requestDevice(a),this.adapterInfo=new cd(t.info||await t.requestAdapterInfo()),this.gpuDataManager=ep(this),this.programManager=new Uf(this),this.kernels=new Map,this.kernelPersistentData=new Map,this.kernelCustomData=new Map,an(e.logLevel,!!e.debug),this.device.onuncapturederror=i=>{i.error instanceof GPUValidationError&&console.error(`An uncaught WebGPU validation error was raised: ${i.error.message}`)},Object.defineProperty(this.env.webgpu,"device",{value:this.device,writable:!1,enumerable:!0,configurable:!1}),Object.defineProperty(this.env.webgpu,"adapter",{value:t,writable:!1,enumerable:!0,configurable:!1}),this.setQueryType()}dispose(){typeof this.querySet<"u"&&this.querySet.destroy(),this.gpuDataManager.dispose()}getCommandEncoder(){return this.commandEncoder||(this.commandEncoder=this.device.createCommandEncoder()),this.commandEncoder}getComputePassEncoder(){if(!this.computePassEncoder){let e=this.getCommandEncoder(),t={};this.queryType==="at-passes"&&(t.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:this.pendingDispatchNumber*2,endOfPassWriteIndex:this.pendingDispatchNumber*2+1}),this.computePassEncoder=e.beginComputePass(t)}return this.computePassEncoder}endComputePass(){this.computePassEncoder&&(this.computePassEncoder.end(),this.computePassEncoder=null)}flush(){if(!this.commandEncoder)return;nt(),this.endComputePass();let e;this.queryType!=="none"&&(this.commandEncoder.resolveQuerySet(this.querySet,0,this.pendingDispatchNumber*2,this.queryResolveBuffer,0),e=this.device.createBuffer({size:this.pendingDispatchNumber*2*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.pendingQueries.set(e,this.pendingKernels),this.pendingKernels=[],this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer,0,e,0,this.pendingDispatchNumber*2*8)),this.device.queue.submit([this.commandEncoder.finish()]),this.gpuDataManager.refreshPendingBuffers(),this.commandEncoder=null,this.pendingDispatchNumber=0,this.queryType!=="none"&&e.mapAsync(GPUMapMode.READ).then(()=>{var a;let t=new BigUint64Array(e.getMappedRange()),r=this.pendingQueries.get(e);for(let n=0;n<t.length/2;n++){let i=r[n],s=i.kernelId,u=this.kernels.get(s),d=u.kernelType,l=u.kernelName,c=i.programName,f=i.inputTensorViews,h=i.outputTensorViews,g=t[n*2],_=t[n*2+1];typeof this.queryTimeBase>"u"&&(this.queryTimeBase=g);let b=Number(g-this.queryTimeBase),x=Number(_-this.queryTimeBase);if(!Number.isSafeInteger(b)||!Number.isSafeInteger(x))throw new RangeError("incorrect timestamp range");if((a=this.env.webgpu.profiling)!=null&&a.ondata)this.env.webgpu.profiling.ondata({version:1,inputsMetadata:f.map($=>({dims:$.dims,dataType:lt($.dataType)})),outputsMetadata:h.map($=>({dims:$.dims,dataType:lt($.dataType)})),kernelId:s,kernelType:d,kernelName:l,programName:c,startTime:b,endTime:x});else{let $="";f.forEach((k,S)=>{$+=`input[${S}]: [${k.dims}] | ${lt(k.dataType)}, `});let w="";h.forEach((k,S)=>{w+=`output[${S}]: [${k.dims}] | ${lt(k.dataType)}, `}),console.log(`[profiling] kernel "${s}|${d}|${l}|${c}" ${$}${w}execution time: ${x-b} ns`)}Hr("GPU",`${c}::${g}::${_}`)}e.unmap(),this.pendingQueries.delete(e)}),Qe()}run(e,t,r,a,n,i){nt(e.name);let s=[];for(let w=0;w<t.length;++w){let k=t[w].data;if(k===0)continue;let S=this.gpuDataManager.get(k);if(!S)throw new Error(`no GPU data for input: ${k}`);s.push(S)}let{outputs:u,dispatchGroup:d,programUniforms:l}=e.getRunData(t),c=r.length===0?u.map((w,k)=>k):r;if(c.length!==u.length)throw new Error(`Output size ${c.length} must be equal to ${u.length}.`);let f=[],h=[];for(let w=0;w<u.length;++w){if(!Number.isInteger(c[w])||c[w]<-3||c[w]>=i)throw new Error(`Invalid output index: ${c[w]}`);if(c[w]===-3)continue;let k=c[w]===-1,S=c[w]===-2,I=k||S?n(u[w].dataType,u[w].dims):a(c[w],u[w].dataType,u[w].dims);if(f.push(I),I.data===0)continue;let E=this.gpuDataManager.get(I.data);if(!E)throw new Error(`no GPU data for output: ${I.data}`);if(k&&this.temporaryData.push(E),S){let z=this.kernelPersistentData.get(this.currentKernelId);z||(z=[],this.kernelPersistentData.set(this.currentKernelId,z)),z.push(E)}h.push(E)}if(s.length!==t.length||h.length!==f.length){if(h.length===0)return Qe(e.name),f;throw new Error(`Program ${e.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`)}let g;if(l){let w=0,k=[];l.forEach(z=>{let A=typeof z.data=="number"?[z.data]:z.data;if(A.length===0)return;let O=z.type===10?2:4,q,K;z.type===10?(K=A.length>4?16:A.length>2?8:A.length*O,q=A.length>4?16:O*A.length):(K=A.length<=2?A.length*O:16,q=16),w=Math.ceil(w/K)*K,k.push(w);let W=z.type===10?8:4;w+=A.length>4?Math.ceil(A.length/W)*q:A.length*O});let S=16;w=Math.ceil(w/S)*S;let I=new ArrayBuffer(w);l.forEach((z,A)=>{let O=k[A],q=typeof z.data=="number"?[z.data]:z.data;if(z.type===6)new Int32Array(I,O,q.length).set(q);else if(z.type===12)new Uint32Array(I,O,q.length).set(q);else if(z.type===10)new Uint16Array(I,O,q.length).set(q);else if(z.type===1)new Float32Array(I,O,q.length).set(q);else throw new Error(`Unsupported uniform type: ${lt(z.type)}`)});let E=this.gpuDataManager.create(w,GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM);this.device.queue.writeBuffer(E.buffer,0,I,0,w),this.gpuDataManager.release(E.id),g={offset:0,size:w,buffer:E.buffer}}let _=this.programManager.normalizeDispatchGroupSize(d),b=_[1]===1&&_[2]===1,x=pd(e,t,b),$=this.programManager.getArtifact(x);if($||($=this.programManager.build(e,_),this.programManager.setArtifact(x,$),le("info",()=>`[artifact] key: ${x}, programName: ${e.name}`)),l&&$.uniformVariablesInfo){if(l.length!==$.uniformVariablesInfo.length)throw new Error(`Uniform variables count mismatch: expect ${$.uniformVariablesInfo.length}, got ${l.length} in program "${$.programInfo.name}".`);for(let w=0;w<l.length;w++){let k=l[w],S=k.type,I=typeof k.data=="number"?1:k.data.length,[E,z]=$.uniformVariablesInfo[w];if(S!==E||I!==z)throw new Error(`Uniform variable ${w} mismatch: expect type ${E} with size ${z}, got type ${S} with size ${I} in program "${$.programInfo.name}".`)}}if(le("info",()=>`[ProgramManager] run "${e.name}" (key=${x}) with ${_[0]}x${_[1]}x${_[2]}`),this.queryType!=="none"||this.sessionStatus==="capturing"){let w={kernelId:this.currentKernelId,programName:$.programInfo.name,inputTensorViews:t,outputTensorViews:f};this.pendingKernels.push(w),this.sessionStatus==="capturing"&&this.capturedPendingKernels.get(this.currentSessionId).push(w)}return this.programManager.run($,s,h,_,g),Qe(e.name),f}upload(e,t){this.gpuDataManager.upload(e,t)}memcpy(e,t){this.gpuDataManager.memcpy(e,t)}async download(e,t){await this.gpuDataManager.download(e,t)}alloc(e){return this.gpuDataManager.create(e).id}free(e){return this.gpuDataManager.release(e)}createKernel(e,t,r,a){let n=Pf.get(e);if(!n)throw new Error(`kernel not implemented: ${e}`);let i={kernelType:e,kernelName:a,kernelEntry:n[0],attributes:[n[1],r]};this.kernels.set(t,i)}releaseKernel(e){let t=this.kernelPersistentData.get(e);if(t){for(let r of t)this.gpuDataManager.release(r.id);this.kernelPersistentData.delete(e)}this.kernelCustomData.delete(e),this.kernels.delete(e)}computeKernel(e,t,r){let a=this.kernels.get(e);if(!a)throw new Error(`kernel not created: ${e}`);let n=a.kernelType,i=a.kernelName,s=a.kernelEntry,u=a.attributes;if(this.currentKernelId!==null)throw new Error(`kernel "[${n}] ${i}" is not allowed to be called recursively`);this.currentKernelId=e,u[0]&&(u[1]=u[0](u[1]),u[0]=void 0),le("info",()=>`[WebGPU] Start to run kernel "[${n}] ${i}"...`);let d=this.env.debug;this.temporaryData=[];try{return d&&this.device.pushErrorScope("validation"),s(t,u[1]),0}catch(l){return r.push(Promise.resolve(`[WebGPU] Kernel "[${n}] ${i}" failed. ${l}`)),1}finally{d&&r.push(this.device.popErrorScope().then(l=>l?`GPU validation error for kernel "[${n}] ${i}": ${l.message}`:null));for(let l of this.temporaryData)this.gpuDataManager.release(l.id);this.temporaryData=[],this.currentKernelId=null}}registerBuffer(e,t,r,a){let n=this.sessionExternalDataMapping.get(e);n||(n=new Map,this.sessionExternalDataMapping.set(e,n));let i=n.get(t),s=this.gpuDataManager.registerExternalBuffer(r,a,i);return n.set(t,[s,r]),s}unregisterBuffers(e){let t=this.sessionExternalDataMapping.get(e);t&&(t.forEach(r=>this.gpuDataManager.unregisterExternalBuffer(r[0])),this.sessionExternalDataMapping.delete(e))}getBuffer(e){let t=this.gpuDataManager.get(e);if(!t)throw new Error(`no GPU data for buffer: ${e}`);return t.buffer}createDownloader(e,t,r){return async()=>{let a=await za(this,e,t);return nn(a.buffer,r)}}writeTimestamp(e){this.queryType==="inside-passes"&&this.computePassEncoder.writeTimestamp(this.querySet,e)}setQueryType(){var e;this.queryType="none",(((e=this.env.webgpu.profiling)==null?void 0:e.mode)==="default"||(typeof this.env.trace>"u"?this.env.wasm.trace:this.env.trace))&&(this.device.features.has("chromium-experimental-timestamp-query-inside-passes")?this.queryType="inside-passes":this.device.features.has("timestamp-query")&&(this.queryType="at-passes"),this.queryType!=="none"&&typeof this.querySet>"u"&&(this.querySet=this.device.createQuerySet({type:"timestamp",count:this.maxDispatchNumber*2}),this.queryResolveBuffer=this.device.createBuffer({size:this.maxDispatchNumber*2*8,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE})))}captureBegin(){le("info","captureBegin"),this.capturedCommandList.get(this.currentSessionId)||this.capturedCommandList.set(this.currentSessionId,[]),this.capturedPendingKernels.get(this.currentSessionId)||this.capturedPendingKernels.set(this.currentSessionId,[]),this.flush(),this.sessionStatus="capturing"}captureEnd(){le("info","captureEnd"),this.flush(),this.sessionStatus="default"}replay(){le("info","replay"),this.sessionStatus="replaying";let e=this.capturedCommandList.get(this.currentSessionId),t=this.capturedPendingKernels.get(this.currentSessionId),r=e.length;this.pendingKernels=[];for(let a=0;a<r;a++){let n=this.getComputePassEncoder(),i=e[a];this.writeTimestamp(this.pendingDispatchNumber*2),n.setPipeline(i.computePipeline),n.setBindGroup(0,i.bindGroup),n.dispatchWorkgroups(...i.dispatchGroup),this.writeTimestamp(this.pendingDispatchNumber*2+1),this.pendingDispatchNumber++,this.queryType!=="none"&&this.pendingKernels.push(t[a]),(this.pendingDispatchNumber>=this.maxDispatchNumber||this.queryType==="at-passes")&&this.endComputePass(),this.pendingDispatchNumber>=this.maxDispatchNumber&&this.flush()}this.flush(),this.sessionStatus="default"}onCreateSession(){this.gpuDataManager.onCreateSession()}onReleaseSession(e){this.unregisterBuffers(e),this.capturedCommandList.has(e)&&this.capturedCommandList.delete(e),this.capturedPendingKernels.has(e)&&this.capturedPendingKernels.delete(e),this.gpuDataManager.onReleaseSession(e)}onRunStart(e){this.currentSessionId=e,this.setQueryType()}}}),Lf={};Ft(Lf,{init:()=>Vf});var Wr,fd,Vf,Fg=U(()=>{J(),ct(),re(),tg(),Wr=class jf{constructor(t,r,a,n){this.module=t,this.dataType=r,this.data=a,this.dims=n}getFloat32Array(){if(this.dataType!==1)throw new Error("Invalid data type");let t=C.size(this.dims);return t===0?new Float32Array:new Float32Array(this.module.HEAP8.buffer,this.data,t)}getBigInt64Array(){if(this.dataType!==7)throw new Error("Invalid data type");let t=C.size(this.dims);return t===0?new BigInt64Array:new BigInt64Array(this.module.HEAP8.buffer,this.data,t)}getInt32Array(){if(this.dataType!==6)throw new Error("Invalid data type");let t=C.size(this.dims);return t===0?new Int32Array:new Int32Array(this.module.HEAP8.buffer,this.data,t)}getUint16Array(){if(this.dataType!==10&&this.dataType!==4)throw new Error("Invalid data type");let t=C.size(this.dims);return t===0?new Uint16Array:new Uint16Array(this.module.HEAP8.buffer,this.data,t)}reshape(t){if(C.size(t)!==C.size(this.dims))throw new Error("Invalid new shape");return new jf(this.module,this.dataType,this.data,t)}},fd=class{constructor(e,t,r){this.module=e,this.backend=t,this.customDataOffset=0,this.customDataSize=0,this.adapterInfo=t.adapterInfo;let a=e.PTR_SIZE,n=r/e.PTR_SIZE,i=a===4?"i32":"i64";this.opKernelContext=Number(e.getValue(a*n++,i));let s=Number(e.getValue(a*n++,i));this.outputCount=Number(e.getValue(a*n++,i)),this.customDataOffset=Number(e.getValue(a*n++,"*")),this.customDataSize=Number(e.getValue(a*n++,i));let u=[];for(let d=0;d<s;d++){let l=Number(e.getValue(a*n++,i)),c=Number(e.getValue(a*n++,"*")),f=Number(e.getValue(a*n++,i)),h=[];for(let g=0;g<f;g++)h.push(Number(e.getValue(a*n++,i)));u.push(new Wr(e,l,c,h))}this.inputs=u}get kernelCustomData(){return this.backend.currentKernelCustomData}get customDataBuffer(){return this.module.HEAPU8.subarray(this.customDataOffset,this.customDataOffset+this.customDataSize)}compute(e,t){var s;let r=((s=t==null?void 0:t.inputs)==null?void 0:s.map(u=>typeof u=="number"?this.inputs[u]:u))??this.inputs,a=(t==null?void 0:t.outputs)??[],n=(u,d,l)=>new Wr(this.module,d,this.output(u,l),l),i=(u,d)=>{let l=Ot(u,d);if(!l)throw new Error(`Unsupported data type: ${u}`);let c=l>0?this.backend.gpuDataManager.create(l).id:0;return new Wr(this.module,u,c,d)};return this.backend.run(e,r,a,n,i,this.outputCount)}output(e,t){let r=this.module.stackSave();try{let a=this.module.PTR_SIZE,n=a===4?"i32":"i64",i=this.module.stackAlloc((1+t.length)*a);this.module.setValue(i,t.length,n);for(let s=0;s<t.length;s++)this.module.setValue(i+a*(s+1),t[s],n);return this.module._JsepOutput(this.opKernelContext,e,i)}catch(a){throw new Error(`Failed to generate kernel's output[${e}] with dims [${t}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${a}`)}finally{this.module.stackRestore(r)}}},Vf=async(e,t,r,a)=>{let n=t.jsepInit;if(!n)throw new Error("Failed to initialize JSEP. The WebAssembly module is not built with JSEP support.");if(e==="webgpu"){let i=(Hg(),gr(qf)).WebGpuBackend,s=new i;await s.initialize(r,a),n("webgpu",[s,u=>s.alloc(Number(u)),u=>s.free(u),(u,d,l,c=!1)=>{if(c)le("verbose",()=>`[WebGPU] jsepCopyGpuToGpu: src=${Number(u)}, dst=${Number(d)}, size=${Number(l)}`),s.memcpy(Number(u),Number(d));else{le("verbose",()=>`[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(u)}, gpuDataId=${Number(d)}, size=${Number(l)}`);let f=t.HEAPU8.subarray(Number(u>>>0),Number(u>>>0)+Number(l));s.upload(Number(d),f)}},async(u,d,l)=>{le("verbose",()=>`[WebGPU] jsepCopyGpuToCpu: gpuDataId=${u}, dataOffset=${d}, size=${l}`),await s.download(Number(u),()=>t.HEAPU8.subarray(Number(d)>>>0,Number(d+l)>>>0))},(u,d,l)=>s.createKernel(u,Number(d),l,t.UTF8ToString(t._JsepGetNodeName(Number(d)))),u=>s.releaseKernel(u),(u,d,l,c)=>{le("verbose",()=>`[WebGPU] jsepRun: sessionHandle=${l}, kernel=${u}, contextDataOffset=${d}`);let f=new fd(t,s,Number(d));return s.computeKernel(Number(u),f,c)},()=>s.captureBegin(),()=>s.captureEnd(),()=>s.replay()])}else{let i=new Jd(r);n("webnn",[i,()=>i.reserveTensorId(),s=>i.releaseTensorId(s),async(s,u,d,l,c)=>i.ensureTensor(s,u,d,l,c),(s,u)=>{i.uploadTensor(s,u)},async(s,u)=>i.downloadTensor(s,u)])}}}),hd,gn,_n,wt,md,ba,Jr,yn,bn,wa,wn,$n,vn,Gf=U(()=>{Ym(),Jm(),J(),Nt(),Ya(),Fd(),hd=(e,t)=>{ye()._OrtInit(e,t)!==0&&me("Can't initialize onnxruntime.")},gn=async e=>{hd(e.wasm.numThreads,Kr(e.logLevel))},_n=async(e,t)=>{var r,a;(a=(r=ye()).asyncInit)==null||a.call(r);{let n=(Fg(),gr(Lf)).init;if(t==="webgpu"){if(typeof navigator>"u"||!navigator.gpu)throw new Error("WebGPU is not supported in current environment");let i=e.webgpu.adapter;if(i){if(typeof i.limits!="object"||typeof i.features!="object"||typeof i.requestDevice!="function")throw new Error("Invalid GPU adapter set in `env.webgpu.adapter`. It must be a GPUAdapter object.")}else{let s=e.webgpu.powerPreference;if(s!==void 0&&s!=="low-power"&&s!=="high-performance")throw new Error(`Invalid powerPreference setting: "${s}"`);let u=e.webgpu.forceFallbackAdapter;if(u!==void 0&&typeof u!="boolean")throw new Error(`Invalid forceFallbackAdapter setting: "${u}"`);if(i=await navigator.gpu.requestAdapter({powerPreference:s,forceFallbackAdapter:u}),!i)throw new Error('Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.')}await n("webgpu",ye(),e,i)}if(t==="webnn"){if(typeof navigator>"u"||!navigator.ml)throw new Error("WebNN is not supported in current environment");await n("webnn",ye(),e)}}},wt=new Map,md=e=>{let t=ye(),r=t.stackSave();try{let a=t.PTR_SIZE,n=t.stackAlloc(2*a);t._OrtGetInputOutputCount(e,n,n+a)!==0&&me("Can't get session input/output count.");let i=a===4?"i32":"i64";return[Number(t.getValue(n,i)),Number(t.getValue(n+a,i))]}finally{t.stackRestore(r)}},ba=(e,t)=>{let r=ye(),a=r.stackSave(),n=0;try{let i=r.PTR_SIZE,s=r.stackAlloc(2*i);r._OrtGetInputOutputMetadata(e,t,s,s+i)!==0&&me("Can't get session input/output metadata.");let u=Number(r.getValue(s,"*"));n=Number(r.getValue(s+i,"*"));let d=r.HEAP32[n/4];if(d===0)return[u,0];let l=r.HEAPU32[n/4+1],c=[];for(let f=0;f<l;f++){let h=Number(r.getValue(n+8+f*i,"*"));c.push(h!==0?r.UTF8ToString(h):Number(r.getValue(n+8+(f+l)*i,"*")))}return[u,d,c]}finally{r.stackRestore(a),n!==0&&r._OrtFree(n)}},Jr=e=>{let t=ye(),r=t._malloc(e.byteLength);if(r===0)throw new Error(`Can't create a session. failed to allocate a buffer of size ${e.byteLength}.`);return t.HEAPU8.set(e,r),[r,e.byteLength]},yn=async(e,t)=>{var f,h,g,_;let r,a,n=ye();Array.isArray(e)?[r,a]=e:e.buffer===n.HEAPU8.buffer?[r,a]=[e.byteOffset,e.byteLength]:[r,a]=Jr(e);let i=0,s=0,u=0,d=[],l=[],c=[];try{if([s,d]=await Hd(t),(t==null?void 0:t.externalData)&&n.mountExternalData){let A=[];for(let O of t.externalData){let q=typeof O=="string"?O:O.path;A.push(rn(typeof O=="string"?O:O.data).then(K=>{n.mountExternalData(q,K)}))}await Promise.all(A)}for(let A of(t==null?void 0:t.executionProviders)??[])if((typeof A=="string"?A:A.name)==="webnn"){if(n.shouldTransferToMLTensor=!1,typeof A!="string"){let O=A,q=O==null?void 0:O.context,K=O==null?void 0:O.gpuDevice,W=O==null?void 0:O.deviceType,Z=O==null?void 0:O.powerPreference;q?n.currentContext=q:K?n.currentContext=await n.webnnCreateMLContext(K):n.currentContext=await n.webnnCreateMLContext({deviceType:W,powerPreference:Z})}else n.currentContext=await n.webnnCreateMLContext();break}i=await n._OrtCreateSession(r,a,s),(f=n.webgpuOnCreateSession)==null||f.call(n,i),i===0&&me("Can't create a session."),(h=n.jsepOnCreateSession)==null||h.call(n),n.currentContext&&(n.webnnRegisterMLContext(i,n.currentContext),n.currentContext=void 0,n.shouldTransferToMLTensor=!0);let[b,x]=md(i),$=!!(t!=null&&t.enableGraphCapture),w=[],k=[],S=[],I=[],E=[];for(let A=0;A<b;A++){let[O,q,K]=ba(i,A);O===0&&me("Can't get an input name."),l.push(O);let W=n.UTF8ToString(O);w.push(W),S.push(q===0?{name:W,isTensor:!1}:{name:W,isTensor:!0,type:lt(q),shape:K})}for(let A=0;A<x;A++){let[O,q,K]=ba(i,A+b);O===0&&me("Can't get an output name."),c.push(O);let W=n.UTF8ToString(O);k.push(W),I.push(q===0?{name:W,isTensor:!1}:{name:W,isTensor:!0,type:lt(q),shape:K});{if($&&(t==null?void 0:t.preferredOutputLocation)===void 0){E.push("gpu-buffer");continue}let Z=typeof(t==null?void 0:t.preferredOutputLocation)=="string"?t.preferredOutputLocation:((g=t==null?void 0:t.preferredOutputLocation)==null?void 0:g[W])??"cpu";if(Z!=="cpu"&&Z!=="cpu-pinned"&&Z!=="gpu-buffer"&&Z!=="ml-tensor")throw new Error(`Not supported preferred output location: ${Z}.`);if($&&Z!=="gpu-buffer")throw new Error(`Not supported preferred output location: ${Z}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);E.push(Z)}}let z=null;return E.some(A=>A==="gpu-buffer"||A==="ml-tensor")&&(u=n._OrtCreateBinding(i),u===0&&me("Can't create IO binding."),z={handle:u,outputPreferredLocations:E,outputPreferredLocationsEncoded:E.map(A=>Ta(A))}),wt.set(i,[i,l,c,z,$,!1]),[i,w,k,S,I]}catch(b){throw l.forEach(x=>n._OrtFree(x)),c.forEach(x=>n._OrtFree(x)),u!==0&&n._OrtReleaseBinding(u)!==0&&me("Can't release IO binding."),i!==0&&n._OrtReleaseSession(i)!==0&&me("Can't release session."),b}finally{n._free(r),s!==0&&n._OrtReleaseSessionOptions(s)!==0&&me("Can't release session options."),d.forEach(b=>n._free(b)),(_=n.unmountExternalData)==null||_.call(n)}},bn=e=>{var d,l,c;let t=ye(),r=wt.get(e);if(!r)throw new Error(`cannot release session. invalid session id: ${e}`);let[a,n,i,s,u]=r;s&&(u&&t._OrtClearBoundOutputs(s.handle)!==0&&me("Can't clear bound outputs."),t._OrtReleaseBinding(s.handle)!==0&&me("Can't release IO binding.")),(d=t.jsepOnReleaseSession)==null||d.call(t,e),(l=t.webnnOnReleaseSession)==null||l.call(t,e),(c=t.webgpuOnReleaseSession)==null||c.call(t,e),n.forEach(f=>t._OrtFree(f)),i.forEach(f=>t._OrtFree(f)),t._OrtReleaseSession(a)!==0&&me("Can't release session."),wt.delete(e)},wa=async(e,t,r,a,n,i,s=!1)=>{if(!e){t.push(0);return}let u=ye(),d=u.PTR_SIZE,l=e[0],c=e[1],f=e[3],h=f,g,_;if(l==="string"&&(f==="gpu-buffer"||f==="ml-tensor"))throw new Error("String tensor is not supported on GPU.");if(s&&f!=="gpu-buffer")throw new Error(`External buffer must be provided for input/output index ${i} when enableGraphCapture is true.`);if(f==="gpu-buffer"){let $=e[2].gpuBuffer;_=Ot(Lt(l),c);{let w=u.jsepRegisterBuffer;if(!w)throw new Error('Tensor location "gpu-buffer" is not supported without using WebGPU.');g=w(a,i,$,_)}}else if(f==="ml-tensor"){let $=e[2].mlTensor;_=Ot(Lt(l),c);let w=u.webnnRegisterMLTensor;if(!w)throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');g=w(a,$,Lt(l),c)}else{let $=e[2];if(Array.isArray($)){_=d*$.length,g=u._malloc(_),r.push(g);for(let w=0;w<$.length;w++){if(typeof $[w]!="string")throw new TypeError(`tensor data at index ${w} is not a string`);u.setValue(g+w*d,Ze($[w],r),"*")}}else{let w=u.webnnIsGraphInput;if(l!=="string"&&w){let k=u.UTF8ToString(n);if(w(a,k)){let S=Lt(l);_=Ot(S,c),h="ml-tensor";let I=u.webnnCreateTemporaryTensor,E=u.webnnUploadTensor;if(!I||!E)throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');let z=await I(a,S,c);E(z,new Uint8Array($.buffer,$.byteOffset,$.byteLength)),g=z}else _=$.byteLength,g=u._malloc(_),r.push(g),u.HEAPU8.set(new Uint8Array($.buffer,$.byteOffset,_),g)}else _=$.byteLength,g=u._malloc(_),r.push(g),u.HEAPU8.set(new Uint8Array($.buffer,$.byteOffset,_),g)}}let b=u.stackSave(),x=u.stackAlloc(4*c.length);try{c.forEach((w,k)=>u.setValue(x+k*d,w,d===4?"i32":"i64"));let $=u._OrtCreateTensor(Lt(l),g,_,x,c.length,Ta(h));$===0&&me(`Can't create tensor for input/output. session=${a}, index=${i}.`),t.push($)}finally{u.stackRestore(b)}},wn=async(e,t,r,a,n,i)=>{var K,W,Z,ue;let s=ye(),u=s.PTR_SIZE,d=wt.get(e);if(!d)throw new Error(`cannot run inference. invalid session id: ${e}`);let l=d[0],c=d[1],f=d[2],h=d[3],g=d[4],_=d[5],b=t.length,x=a.length,$=0,w=[],k=[],S=[],I=[],E=s.stackSave(),z=s.stackAlloc(b*u),A=s.stackAlloc(b*u),O=s.stackAlloc(x*u),q=s.stackAlloc(x*u);try{[$,w]=Gd(i);for(let L=0;L<b;L++)await wa(r[L],k,I,e,c[t[L]],t[L],g);for(let L=0;L<x;L++)await wa(n[L],S,I,e,f[a[L]],b+a[L],g);for(let L=0;L<b;L++)s.setValue(z+L*u,k[L],"*"),s.setValue(A+L*u,c[t[L]],"*");for(let L=0;L<x;L++)s.setValue(O+L*u,S[L],"*"),s.setValue(q+L*u,f[a[L]],"*");if(h&&!_){let{handle:L,outputPreferredLocations:de,outputPreferredLocationsEncoded:te}=h;if(c.length!==b)throw new Error(`input count from feeds (${b}) is expected to be always equal to model's input count (${c.length}).`);for(let ae=0;ae<b;ae++){let M=t[ae];await s._OrtBindInput(L,c[M],k[ae])!==0&&me(`Can't bind input[${ae}] for session=${e}.`)}for(let ae=0;ae<x;ae++){let M=a[ae];(K=n[ae])!=null&&K[3]?s._OrtBindOutput(L,f[M],S[ae],0)!==0&&me(`Can't bind pre-allocated output[${ae}] for session=${e}.`):s._OrtBindOutput(L,f[M],0,te[M])!==0&&me(`Can't bind output[${ae}] to ${de[ae]} for session=${e}.`)}wt.set(e,[l,c,f,h,g,!0])}(W=s.jsepOnRunStart)==null||W.call(s,l),(Z=s.webnnOnRunStart)==null||Z.call(s,l);let ee;h?ee=await s._OrtRunWithBinding(l,h.handle,x,O,$):ee=await s._OrtRun(l,A,z,b,q,x,O,$),ee!==0&&me("failed to call OrtRun().");let j=[];for(let L=0;L<x;L++){let de=Number(s.getValue(O+L*u,"*"));if(de===S[L]){j.push(n[L]);continue}let te=s.stackSave(),ae=s.stackAlloc(4*u),M=!1,P,G=0;try{s._OrtGetTensorData(de,ae,ae+u,ae+2*u,ae+3*u)!==0&&me(`Can't access output tensor data on index ${L}.`);let se=u===4?"i32":"i64",Ie=Number(s.getValue(ae,se));G=s.getValue(ae+u,"*");let D=s.getValue(ae+u*2,"*"),ge=Number(s.getValue(ae+u*3,se)),qe=[];for(let Se=0;Se<ge;Se++)qe.push(Number(s.getValue(D+Se*u,se)));s._OrtFree(D)!==0&&me("Can't free memory for tensor dims.");let Be=qe.reduce((Se,he)=>Se*he,1);P=lt(Ie);let St=h==null?void 0:h.outputPreferredLocations[a[L]];if(P==="string"){if(St==="gpu-buffer"||St==="ml-tensor")throw new Error("String tensor is not supported on GPU.");let Se=[];for(let he=0;he<Be;he++){let et=s.getValue(G+he*u,"*"),Zt=s.getValue(G+(he+1)*u,"*"),kt=he===Be-1?void 0:Zt-et;Se.push(s.UTF8ToString(et,kt))}j.push([P,qe,Se,"cpu"])}else if(St==="gpu-buffer"&&Be>0){let Se=s.jsepGetBuffer;if(!Se)throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');let he=Se(G),et=Ot(Ie,Be);if(et===void 0||!en(P))throw new Error(`Unsupported data type: ${P}`);M=!0,j.push([P,qe,{gpuBuffer:he,download:s.jsepCreateDownloader(he,et,P),dispose:()=>{s._OrtReleaseTensor(de)!==0&&me("Can't release tensor.")}},"gpu-buffer"])}else if(St==="ml-tensor"&&Be>0){let Se=s.webnnEnsureTensor,he=s.webnnIsInt64Supported;if(!Se||!he)throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');if(Ot(Ie,Be)===void 0||!tn(P))throw new Error(`Unsupported data type: ${P}`);if(P==="int64"&&!he(e))throw new Error('preferredLocation "ml-tensor" for int64 output is not supported by current WebNN Context.');let et=await Se(e,G,Ie,qe,!1);M=!0,j.push([P,qe,{mlTensor:et,download:s.webnnCreateMLTensorDownloader(G,P),dispose:()=>{s.webnnReleaseTensorId(G),s._OrtReleaseTensor(de)}},"ml-tensor"])}else{let Se=Ja(P),he=new Se(Be);new Uint8Array(he.buffer,he.byteOffset,he.byteLength).set(s.HEAPU8.subarray(G,G+he.byteLength)),j.push([P,qe,he,"cpu"])}}finally{s.stackRestore(te),P==="string"&&G&&s._free(G),M||s._OrtReleaseTensor(de),(ue=s.webnnOnRunEnd)==null||ue.call(s,l)}}return h&&!g&&(s._OrtClearBoundOutputs(h.handle)!==0&&me("Can't clear bound outputs."),wt.set(e,[l,c,f,h,g,!1])),j}finally{s.stackRestore(E),k.forEach(ee=>s._OrtReleaseTensor(ee)),S.forEach(ee=>s._OrtReleaseTensor(ee)),I.forEach(ee=>s._free(ee)),$!==0&&s._OrtReleaseRunOptions($),w.forEach(ee=>s._free(ee))}},$n=e=>{let t=ye(),r=wt.get(e);if(!r)throw new Error("invalid session id");let a=r[0],n=t._OrtEndProfiling(a);n===0&&me("Can't get an profile file name."),t._OrtFree(n)},vn=e=>{let t=[];for(let r of e){let a=r[2];!Array.isArray(a)&&"buffer"in a&&t.push(a.buffer)}return t}}),$t,Re,Wt,lr,dr,Lr,$a,Vr,zt,Ct,gd,Hf,Ff,Kf,Zf,Qf,Xf,Yf,Jf=U(()=>{Je(),Gf(),Nt(),Qa(),$t=()=>!!be.wasm.proxy&&typeof document<"u",Wt=!1,lr=!1,dr=!1,Vr=new Map,zt=(e,t)=>{let r=Vr.get(e);r?r.push(t):Vr.set(e,[t])},Ct=()=>{if(Wt||!lr||dr||!Re)throw new Error("worker not ready")},gd=e=>{switch(e.data.type){case"init-wasm":Wt=!1,e.data.err?(dr=!0,$a[1](e.data.err)):(lr=!0,$a[0]()),Lr&&(URL.revokeObjectURL(Lr),Lr=void 0);break;case"init-ep":case"copy-from":case"create":case"release":case"run":case"end-profiling":{let t=Vr.get(e.data.type);e.data.err?t.shift()[1](e.data.err):t.shift()[0](e.data.out);break}}},Hf=async()=>{if(!lr){if(Wt)throw new Error("multiple calls to 'initWasm()' detected.");if(dr)throw new Error("previous call to 'initWasm()' failed.");if(Wt=!0,$t())return new Promise((e,t)=>{Re==null||Re.terminate(),Vd().then(([r,a])=>{try{Re=a,Re.onerror=i=>t(i),Re.onmessage=gd,$a=[e,t];let n={type:"init-wasm",in:be};!n.in.wasm.wasmPaths&&(r||Ia)&&(n.in.wasm.wasmPaths={wasm:new URL("/assets/ort-wasm-simd-threaded.jsep-B0T3yYHD.wasm",import.meta.url).href}),Re.postMessage(n),Lr=r}catch(n){t(n)}},t)});try{await Xa(be.wasm),await gn(be),lr=!0}catch(e){throw dr=!0,e}finally{Wt=!1}}},Ff=async e=>{if($t())return Ct(),new Promise((t,r)=>{zt("init-ep",[t,r]);let a={type:"init-ep",in:{epName:e,env:be}};Re.postMessage(a)});await _n(be,e)},Kf=async e=>$t()?(Ct(),new Promise((t,r)=>{zt("copy-from",[t,r]);let a={type:"copy-from",in:{buffer:e}};Re.postMessage(a,[e.buffer])})):Jr(e),Zf=async(e,t)=>{if($t()){if(t!=null&&t.preferredOutputLocation)throw new Error('session option "preferredOutputLocation" is not supported for proxy.');return Ct(),new Promise((r,a)=>{zt("create",[r,a]);let n={type:"create",in:{model:e,options:{...t}}},i=[];e instanceof Uint8Array&&i.push(e.buffer),Re.postMessage(n,i)})}else return yn(e,t)},Qf=async e=>{if($t())return Ct(),new Promise((t,r)=>{zt("release",[t,r]);let a={type:"release",in:e};Re.postMessage(a)});bn(e)},Xf=async(e,t,r,a,n,i)=>{if($t()){if(r.some(s=>s[3]!=="cpu"))throw new Error("input tensor on GPU is not supported for proxy.");if(n.some(s=>s))throw new Error("pre-allocated output tensor is not supported for proxy.");return Ct(),new Promise((s,u)=>{zt("run",[s,u]);let d=r,l={type:"run",in:{sessionId:e,inputIndices:t,inputs:d,outputIndices:a,options:i}};Re.postMessage(l,vn(d))})}else return wn(e,t,r,a,n,i)},Yf=async e=>{if($t())return Ct(),new Promise((t,r)=>{zt("end-profiling",[t,r]);let a={type:"end-profiling",in:e};Re.postMessage(a)});$n(e)}}),va,_d,eh,Kg=U(()=>{Je(),Jf(),J(),Za(),Fd(),va=(e,t)=>{switch(e.location){case"cpu":return[e.type,e.dims,e.data,"cpu"];case"gpu-buffer":return[e.type,e.dims,{gpuBuffer:e.gpuBuffer},"gpu-buffer"];case"ml-tensor":return[e.type,e.dims,{mlTensor:e.mlTensor},"ml-tensor"];default:throw new Error(`invalid data location: ${e.location} for ${t()}`)}},_d=e=>{switch(e[3]){case"cpu":return new Ve(e[0],e[2],e[1]);case"gpu-buffer":{let t=e[0];if(!en(t))throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);let{gpuBuffer:r,download:a,dispose:n}=e[2];return Ve.fromGpuBuffer(r,{dataType:t,dims:e[1],download:a,dispose:n})}case"ml-tensor":{let t=e[0];if(!tn(t))throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);let{mlTensor:r,download:a,dispose:n}=e[2];return Ve.fromMLTensor(r,{dataType:t,dims:e[1],download:a,dispose:n})}default:throw new Error(`invalid data location: ${e[3]}`)}},eh=class{async fetchModelAndCopyToWasmMemory(e){return Kf(await rn(e))}async loadModel(e,t){nt();let r;typeof e=="string"?r=await this.fetchModelAndCopyToWasmMemory(e):r=e,[this.sessionId,this.inputNames,this.outputNames,this.inputMetadata,this.outputMetadata]=await Zf(r,t),Qe()}async dispose(){return Qf(this.sessionId)}async run(e,t,r){nt();let a=[],n=[];Object.entries(e).forEach(f=>{let h=f[0],g=f[1],_=this.inputNames.indexOf(h);if(_===-1)throw new Error(`invalid input '${h}'`);a.push(g),n.push(_)});let i=[],s=[];Object.entries(t).forEach(f=>{let h=f[0],g=f[1],_=this.outputNames.indexOf(h);if(_===-1)throw new Error(`invalid output '${h}'`);i.push(g),s.push(_)});let u=a.map((f,h)=>va(f,()=>`input "${this.inputNames[n[h]]}"`)),d=i.map((f,h)=>f?va(f,()=>`output "${this.outputNames[s[h]]}"`):null),l=await Xf(this.sessionId,n,u,s,d,r),c={};for(let f=0;f<l.length;f++)c[this.outputNames[s[f]]]=i[f]??_d(l[f]);return Qe(),c}startProfiling(){}endProfiling(){Yf(this.sessionId)}}}),th={};Ft(th,{OnnxruntimeWebAssemblyBackend:()=>Wa,initializeFlags:()=>qa,wasmBackend:()=>rh});var qa,Wa,rh,Zg=U(()=>{Je(),Jf(),Kg(),qa=()=>{(typeof be.wasm.initTimeout!="number"||be.wasm.initTimeout<0)&&(be.wasm.initTimeout=0);let e=be.wasm.simd;if(typeof e!="boolean"&&e!==void 0&&e!=="fixed"&&e!=="relaxed"&&(console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`),be.wasm.simd=!1),typeof be.wasm.proxy!="boolean"&&(be.wasm.proxy=!1),typeof be.wasm.trace!="boolean"&&(be.wasm.trace=!1),typeof be.wasm.numThreads!="number"||!Number.isInteger(be.wasm.numThreads)||be.wasm.numThreads<=0)if(typeof self<"u"&&!self.crossOriginIsolated)be.wasm.numThreads=1;else{let t=typeof navigator>"u"?Rm("node:os").cpus().length:navigator.hardwareConcurrency;be.wasm.numThreads=Math.min(4,Math.ceil((t||1)/2))}},Wa=class{async init(e){qa(),await Hf(),await Ff(e)}async createInferenceSessionHandler(e,t){let r=new eh;return await r.loadModel(e,t),r}},rh=new Wa});Je();Je();Je();var Qg="1.22.0-dev.20250409-89f8206ba4";{let e=(Zg(),gr(th)).wasmBackend;Vt("webgpu",e,5),Vt("webnn",e,5),Vt("cpu",e,10),Vt("wasm",e,10)}Object.defineProperty(be.versions,"web",{value:Qg,enumerable:!0});/**
* @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Xg(e){let t=e.width,r=e.height,a=-1,n=-1;for(let i=0;i<e.height;i++)for(let s=0;s<e.width;s++)(e.data[(i*e.width+s)*4+3]>0||e.data[(i*e.width+s)*4]>0)&&(t=Math.min(t,s),r=Math.min(r,i),a=Math.max(a,s),n=Math.max(n,i));return a<0?null:{x:t,y:r,width:a-t+1,height:n-r+1}}function yd(e){const t=new ImageData(e.width,e.height);for(let r=0;r<e.data.length;r+=4){const a=e.data[r]>127||e.data[r+3]>127?255:0;t.data[r]=t.data[r+1]=t.data[r+2]=a,t.data[r+3]=255}return t}function Yg(e,t){if(t<=0)return yd(e);const r=yd(e),a=new ImageData(e.width,e.height),n=t*t;for(let i=0;i<r.height;i++)for(let s=0;s<r.width;s++){let u=!1;for(let l=-t;l<=t&&!u;l++)for(let c=-t;c<=t;c++){if(c*c+l*l>n)continue;const f=s+c,h=i+l;if(f>=0&&h>=0&&f<r.width&&h<r.height&&r.data[(h*r.width+f)*4]>0){u=!0;break}}const d=(i*r.width+s)*4;a.data[d]=a.data[d+1]=a.data[d+2]=u?255:0,a.data[d+3]=255}return a}function Jg(e,t){if(t<=0)return e;const r=new ImageData(e.width,e.height),a=Math.ceil(t);for(let n=0;n<e.height;n++)for(let i=0;i<e.width;i++){let s=0,u=0;for(let c=-a;c<=a;c++)for(let f=-a;f<=a;f++){const h=i+f,g=n+c;h>=0&&g>=0&&h<e.width&&g<e.height&&(s+=e.data[(g*e.width+h)*4],u++)}const d=(n*e.width+i)*4,l=Math.round(s/u);r.data[d]=r.data[d+1]=r.data[d+2]=l,r.data[d+3]=255}return r}function e0(e,t,r,a){const n=Math.max(0,Math.floor(e.x-t)),i=Math.max(0,Math.floor(e.y-t)),s=Math.min(r,Math.ceil(e.x+e.width+t)),u=Math.min(a,Math.ceil(e.y+e.height+t));return{x:n,y:i,width:s-n,height:u-i}}function xa(e,t,r){const a=document.createElement("canvas"),n=document.createElement("canvas");a.width=e.width,a.height=e.height,n.width=t,n.height=r,a.getContext("2d").putImageData(e,0,0);const i=n.getContext("2d");return i.imageSmoothingEnabled=!0,i.drawImage(a,0,0,t,r),i.getImageData(0,0,t,r)}class t0{constructor(t="/models/lama.onnx"){er(this,"session",null);er(this,"modelPromise",null);er(this,"lastTiming",{});this.modelPath=t}async load(){if(!navigator.gpu)throw new Error("WebGPU is unavailable. Use a recent Chrome or Edge browser with WebGPU enabled.");this.modelPromise||(this.modelPromise=Ka.create(this.modelPath,{executionProviders:["webgpu"]}).then(t=>(this.session=t,t)));try{return await this.modelPromise}catch{throw this.modelPromise=null,new Error(`Could not load the local LaMa model at ${this.modelPath}.`)}}async inpaint(t,r,a){var q,K;const n=performance.now(),i=Xg(r);if(!i)throw new Error("Paint an area to remove before running inpainting.");const s=await this.load(),u=Yg(r,a.maskDilation),d=e0(i,a.cropPadding,t.width,t.height),l=r0(a.inferenceSize,d.width,d.height),c=xa(xi(t,d),l,l),f=xa(xi(u,d),l,l);(q=a.onStatus)==null||q.call(a,"Running local AI");const h=performance.now(),g=new Float32Array(l*l*3),_=new Float32Array(l*l);for(let W=0;W<l*l;W++)g[W]=c.data[W*4]/255,g[l*l+W]=c.data[W*4+1]/255,g[l*l*2+W]=c.data[W*4+2]/255,_[W]=f.data[W*4]>127?1:0;this.lastTiming.preprocess=performance.now()-h;const b=new Ve("float32",g,[1,3,l,l]),x=new Ve("float32",_,[1,1,l,l]),$=performance.now();let w;try{w=await s.run({[s.inputNames[0]]:b,[s.inputNames[1]]:x})}catch(W){throw console.error("[AnyPNG] WebGPU inference failed",W),new Error("Local inference failed. The model may use an unsupported operator or require more GPU memory.")}this.lastTiming.inference=performance.now()-$;const S=w[s.outputNames[0]].data,I=new ImageData(d.width,d.height),E=xa(f,d.width,d.height),z=Jg(xi(E,{x:0,y:0,width:E.width,height:E.height}),a.blendFeather);for(let W=0;W<d.width*d.height;W++){const Z=Math.min(l-1,Math.floor(W%d.width*l/d.width)),ue=Math.min(l-1,Math.floor(Math.floor(W/d.width)*l/d.height)),ee=ue*l+Z;I.data[W*4]=Sa(S[ee]*255),I.data[W*4+1]=Sa(S[l*l+ee]*255),I.data[W*4+2]=Sa(S[l*l*2+ee]*255),I.data[W*4+3]=255}(K=a.onStatus)==null||K.call(a,"Blending result");const A=performance.now(),O=zm(t,I,z,d);return this.lastTiming.composite=performance.now()-A,this.lastTiming.total=performance.now()-n,O}dispose(){var t;(t=this.session)==null||t.release(),this.session=null,this.modelPromise=null}}function Sa(e){return Math.max(0,Math.min(255,Math.round(e)))}function r0(e,t,r){if(e!=="auto")return e;const a=Math.max(t,r);return a>1800?1024:a>900?768:512}const i0=document.querySelector("#app");i0.innerHTML=`<header><div><span class="eyebrow">ANYPNG / LOCAL AI</span><h1>Inpaint images privately</h1><p>Mask an unwanted overlay and reconstruct it locally in your browser.</p></div><div id="gpu-badge" class="badge">Checking WebGPU…</div></header>
...
<aside><section class="card"><h2>Inference</h2><div class="segmented"><label><input type="radio" name="size" value="512" checked>512</label><label><input type="radio" name="size" value="768">768</label><label><input type="radio" name="size" value="1024">1024</label><label><input type="radio" name="size" value="auto">Auto</label></div><button id="run" class="primary full" disabled>Remove selected area</button><div id="status" class="status">Upload an image to begin.</div></section><section class="card"><h2>Export</h2><select id="format"><option value="png">PNG</option><option value="jpeg">JPEG</option><option value="webp">WebP</option></select><label class="quality">Quality <input id="quality" type="range" min="10" max="100" value="92"><output id="quality-value">92%</output></label><button id="download" class="secondary full" disabled>Download result</button></section><section class="card diagnostics"><h2>Diagnostics</h2><dl><dt>WebGPU</dt><dd id="gpu-detail">—</dd><dt>Model</dt><dd id="model-time">—</dd><dt>Preprocess</dt><dd id="prep-time">—</dd><dt>Inference</dt><dd id="infer-time">—</dd><dt>Composite</dt><dd id="comp-time">—</dd><dt>Total</dt><dd id="total-time">—</dd></dl><div id="debug" class="debug hidden"></div></section></aside></main>`;const La=document.querySelector("#image-canvas"),Ee=document.querySelector("#mask-canvas"),Va=document.querySelector("#canvas-wrap"),bd=document.querySelector("#stage"),ih=La.getContext("2d"),Ce=Ee.getContext("2d"),yr=new t0;let Me=null,Dt=null,ei=!1,ah="paint",ja=.55,Ga=48,ka=1,dt=[],Ye=-1;const oe=e=>document.querySelector(`#${e}`),pt=document.createElement("button");pt.id="benchmark";pt.className="secondary full";pt.disabled=!0;pt.textContent="Benchmark 512 / 768 / 1024";oe("run").after(pt);function Xe(e){oe("status").textContent=e}function Kt(){Ce.clearRect(0,0,Ee.width,Ee.height),dt[Ye]&&Ce.putImageData(dt[Ye],0,0),Ce.globalAlpha=ja,Ce.globalCompositeOperation="source-over",Ce.fillStyle="#ff4d78";const e=Ce.getImageData(0,0,Ee.width,Ee.height);for(let t=0;t<e.data.length;t+=4)e.data[t+3]&&(e.data[t]=255,e.data[t+1]=77,e.data[t+2]=120,e.data[t+3]=Math.round(255*ja));Ce.putImageData(e,0,0),Ce.globalAlpha=1}function xn(){Me&&(ih.putImageData(Dt&&oe("before").dataset.down!=="1"?Dt:Me,0,0),Kt())}function nh(){const e=Ce.getImageData(0,0,Ee.width,Ee.height);dt=dt.slice(0,Ye+1),dt.push(e),Ye++,Kt()}function a0(e){const t=Ee.getBoundingClientRect();return{x:Math.max(0,Math.min(Ee.width-1,(e.clientX-t.left)*Ee.width/t.width)),y:Math.max(0,Math.min(Ee.height-1,(e.clientY-t.top)*Ee.height/t.height))}}function sh(e){const t=a0(e);Ce.save(),Ce.globalCompositeOperation=ah==="erase"?"destination-out":"source-over",Ce.fillStyle="rgba(255,77,120,1)",Ce.beginPath(),Ce.arc(t.x,t.y,Ga/2,0,Math.PI*2),Ce.fill(),Ce.restore(),Kt()}function Sn(e){Em(e).then(t=>{Me=t,Dt=null,[La.width,Ee.width]=[t.width,t.width],[La.height,Ee.height]=[t.height,t.height],dt=[new ImageData(t.width,t.height)],Ye=0,Va.classList.remove("hidden"),oe("dropzone").classList.add("hidden"),oe("run").removeAttribute("disabled"),pt.disabled=!1,oe("download").setAttribute("disabled",""),ti(),xn(),Xe(`${t.width} × ${t.height} ready. Paint the area to remove.`)}).catch(()=>Xe("Could not read that image. Try PNG, JPG, or WebP."))}function ti(){if(!Me)return;const e=Va.clientWidth-24,t=Math.max(360,window.innerHeight*.65);ka=Math.min(1,e/Me.width,t/Me.height),bd.style.transform=`scale(${ka})`,bd.style.transformOrigin="top left",Va.style.height=`${Me.height*ka+24}px`}oe("upload").onclick=()=>oe("file").click();oe("file").onchange=()=>{var t;const e=(t=oe("file").files)==null?void 0:t[0];e&&Sn(e)};["dragover","drop"].forEach(e=>oe("dropzone").addEventListener(e,t=>{var r;if(t.preventDefault(),e==="drop"){const a=(r=t.dataTransfer)==null?void 0:r.files[0];a&&Sn(a)}}));Ee.addEventListener("pointerdown",e=>{ei=!0,Ee.setPointerCapture(e.pointerId),sh(e)});Ee.addEventListener("pointermove",e=>{ei&&sh(e)});Ee.addEventListener("pointerup",()=>{ei&&(ei=!1,nh())});document.querySelectorAll(".tool[data-mode]").forEach(e=>e.onclick=()=>{ah=e.dataset.mode,document.querySelectorAll(".tool[data-mode]").forEach(t=>t.classList.toggle("active",t===e))});oe("brush").oninput=e=>{Ga=Number(e.target.value),oe("brush-value").textContent=`${Ga} px`};oe("opacity").oninput=e=>{ja=Number(e.target.value)/100,Kt()};oe("undo").onclick=()=>{Ye>0&&(Ye--,Kt())};oe("redo").onclick=()=>{Ye<dt.length-1&&(Ye++,Kt())};oe("clear").onclick=()=>{Me&&(Ce.clearRect(0,0,Me.width,Me.height),nh())};oe("fit").onclick=ti;oe("reset").onclick=ti;oe("before").onpointerdown=()=>{oe("before").dataset.down="1",xn()};oe("before").onpointerup=()=>{delete oe("before").dataset.down,xn()};oe("quality").oninput=e=>oe("quality-value").textContent=`${e.target.value}%`;async function n0(){if(!Me)return;const e=performance.now();try{Xe("Preparing image…");const t=document.querySelector("input[name=size]:checked").value,r=t==="auto"?"auto":Number(t);Dt=await yr.inpaint(Me,dt[Ye],{inferenceSize:r,maskDilation:8,cropPadding:64,blendFeather:8,onStatus:Xe}),ih.putImageData(Dt,0,0),oe("download").removeAttribute("disabled");const a=yr.lastTiming;oe("prep-time").textContent=`${Math.round(a.preprocess??0)} ms`,oe("infer-time").textContent=`${Math.round(a.inference??0)} ms`,oe("comp-time").textContent=`${Math.round(a.composite??0)} ms`,oe("total-time").textContent=`${Math.round(performance.now()-e)} ms`,oe("status").textContent="Done. Hold “original” to compare."}catch(t){console.error("[AnyPNG] inpainting error",t),Xe(t instanceof Error?t.message:"Inpainting failed.")}}oe("run").onclick=n0;oe("download").onclick=()=>{if(!Dt)return;const e=oe("format").value,t=Number(oe("quality").value)/100;Cm(Dt).toBlob(a=>{if(!a)return;const n=document.createElement("a");n.href=URL.createObjectURL(a),n.download=`AnyPNG_Inpainted_${Date.now()}.${e}`,n.click(),setTimeout(()=>URL.revokeObjectURL(n.href),1e3)},`image/${e}`,e==="png"?void 0:t)};pt.onclick=async()=>{if(!Me)return;const e=dt[Ye];pt.disabled=!0;try{for(const t of[512,768,1024])Xe(`Benchmarking ${t}…`),await yr.inpaint(Me,e,{inferenceSize:t,maskDilation:8,cropPadding:64,blendFeather:8}),console.log(`[AnyPNG] benchmark ${t}`,yr.lastTiming);Xe("Benchmark complete. See the developer console for timings.")}catch(t){console.error("[AnyPNG] benchmark failed",t),Xe(t instanceof Error?t.message:"Benchmark failed.")}finally{pt.disabled=!1}};(async()=>{const e=oe("gpu-badge");if(!navigator.gpu){e.textContent="WebGPU unavailable",e.classList.add("error"),oe("gpu-detail").textContent="No";return}e.textContent="WebGPU ready",oe("gpu-detail").textContent="Yes",new URLSearchParams(location.search).get("debug")==="true"&&oe("debug").classList.remove("hidden");try{const r=performance.now();await yr.load(),oe("model-time").textContent=`${Math.round(performance.now()-r)} ms`,Xe("Local model ready. Upload an image to begin.")}catch(r){console.error("[AnyPNG] model load",r),Xe(r instanceof Error?r.message:"Model could not be loaded.")}})();window.addEventListener("resize",ti);async function s0(){const e=new URLSearchParams(location.search).get("job");if(!e)return;const t=await new Promise((r,a)=>{const n=indexedDB.open("anypng-local-editor",1);n.onerror=()=>a(n.error),n.onsuccess=()=>{const i=n.result.transaction("jobs","readonly").objectStore("jobs").get(e);i.onsuccess=()=>{var s;return(s=i.result)!=null&&s.blob?r(i.result.blob):a(new Error("The image hand-off expired."))},i.onerror=()=>a(i.error)}});Sn(t)}s0().catch(e=>{console.error("[AnyPNG] extension image hand-off",e),Xe(e instanceof Error?e.message:"Could not load the selected image.")});
